...
![[Prompt Injection vs Jailbreak vs Tool Poisoning.excalidraw]]

边界：这张图是学习型边界图，基于本卡、[[Tool Poisoning]] 和 [[Agent 安全控制点对比]] 的工程综合；它不是新增 source evidence。图中的 Jailbreak 暂作为相邻术语普通标注，不在本次图示请求中创建弱概念卡。
