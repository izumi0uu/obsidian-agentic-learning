...
- [[AI Engineering From Scratch - Prompt Engineering#关键事实]] / [[AI Engineering From Scratch - Prompt Engineering#边界提醒]]：支持 vague prompt 与 engineered prompt 的分布收窄比喻，并记录“不是训练数据检索”的机制边界。
