...
- [[LLM 基础结构对比]]：先用一张边界页切开 token embedding、Transformer、self-attention、scaled dot-product attention、multi-head attention、masked attention 和 positional encoding。
- [[Token Embedding]]
- [[Transformer]]
- [[Self-Attention]]
- [[Scaled Dot-Product Attention]]
...
- [[Agent Harness 缓存分层与命中率]]：把 KV cache、Prompt Caching、tool / retrieval / embedding / summary cache 的控制层和命中率含义分开。
- [[Gating Mechanism]]：模型内部选择性放行特征、激活专家或调制计算路径的机制，注意它不是执行前审批 gate。
...
- Concept anchors: [[LLM#证据锚点]], [[Token#证据锚点]], [[Token Embedding#证据锚点]], [[Context Window#证据锚点]], [[KV Cache#证据锚点]], [[Gating Mechanism#证据锚点]], [[Prompt#证据锚点]], [[Prompt Engineering#证据锚点]], [[Few-shot Prompting#证据锚点]], [[Few-shot CoT#证据锚点]], [[Self-Consistency#证据锚点]], [[Structured Outputs#证据锚点]], [[Hallucination#证据锚点]], [[Context Engineering#证据锚点]], [[Transformer#证据锚点]], [[Scaled Dot-Product Attention#证据锚点]], [[Masked Attention#证据锚点]]。
...
- Course route source: [[AI Engineering From Scratch#快速 Agent 开发路线]]。
