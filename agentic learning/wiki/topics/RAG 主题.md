...
| 召回与融合 | [[Retriever]], [[Query Rewrite]], [[Query Planning]], [[Hybrid Search]] | query 如何找到候选证据，是否需要改写、分解或规划 | top-k 漏掉关键文档、专有名词/编号匹配失败、query rewrite 偏题、query plan 过度复杂 |
...
- Concept anchors: [[RAG#证据锚点]], [[Retriever#证据锚点]], [[Query Rewrite#证据锚点]], [[Query Planning#证据锚点]], [[Document Ingestion#证据锚点]], [[Chunking#证据锚点]], [[Embedding#证据锚点]], [[Vector Database#证据锚点]], [[Hybrid Search#证据锚点]], [[Reranking#证据锚点]], [[RAG Evaluation#证据锚点]], [[RAG Citation Faithfulness#证据锚点]], [[RAG Access Control#证据锚点]], [[Knowledge Graph#证据锚点]], [[Entity Resolution#证据锚点]], [[Graph Construction Evaluation#证据锚点]], [[GraphRAG#证据锚点]], [[Neo4j#证据锚点]]。
