...
底层机制边界见 [[Constrained Decoding]] 和 [[OpenAI Structured Outputs 文档#Constrained decoding 锚点]]：Structured Outputs 的可靠性不是单靠自然语言提示，而是把 schema adherence 下沉到生成过程和解码约束中。
