...
🙋‍♂️我：哦，还有[[Memory|记忆]]，就是把上下文存进去，让它记得之前的步骤。
...
我理解 Agent 的基本架构有四个核心组件：LLM、工具、记忆、[[Planning|规划]]模块。
...
其次是[[Tool Calling|工具调用]]的稳定性，有些模型生成的 JSON 格式经常出错、参数乱填，导致工具调用失败，这在生产环境里会带来大量的重试和 token 浪费。
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/2_components.html#main-content)
...
- [2. Agent 的基本架构由哪些核心组件构成？](https://xiaolinnote.com/ai/agent/2_components.html#_2-agent-的基本架构由哪些核心组件构成)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/2_components.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/2_components.html#📝-详细解析)
- [LLM 核心](https://xiaolinnote.com/ai/agent/2_components.html#llm-核心)
- [工具系统](https://xiaolinnote.com/ai/agent/2_components.html#工具系统)
- [记忆系统](https://xiaolinnote.com/ai/agent/2_components.html#记忆系统)
- [规划模块](https://xiaolinnote.com/ai/agent/2_components.html#规划模块)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/2_components.html#🎯-面试总结)
- [上一页 1. 什么是 Agent？与大模型有什么本质不同？](https://xiaolinnote.com/ai/agent/1_whatisagent.html)
- [下一页 3. Workflow，Agent，Tools 这三个的概念和区别介绍一下？](https://xiaolinnote.com/ai/agent/3_workflow_tools.html)
