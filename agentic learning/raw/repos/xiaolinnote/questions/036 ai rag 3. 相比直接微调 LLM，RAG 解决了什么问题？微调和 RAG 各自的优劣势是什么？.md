...
### [微调（Fine-tuning）：把知识直接烧进模型](#微调-fine-tuning-把知识直接烧进模型)
...
### [RAG：不改参数，推理时现查知识](#rag-不改参数-推理时现查知识)
...
### [组合使用：微调解决「怎么说」，RAG 解决「说什么」](#组合使用-微调解决「怎么说」-rag-解决「说什么」)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#main-content)
...
- [3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#_3-相比直接微调-llm-rag-解决了什么问题-微调和-rag-各自的优劣势是什么)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#📝-详细解析)
- [微调（Fine-tuning）：把知识直接烧进模型](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#微调-fine-tuning-把知识直接烧进模型)
- [RAG：不改参数，推理时现查知识](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#rag-不改参数-推理时现查知识)
- [组合使用：微调解决「怎么说」，RAG 解决「说什么」](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#组合使用-微调解决「怎么说」-rag-解决「说什么」)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html#🎯-面试总结)
- [上一页 2. 大模型的 RAG 主要用来解决什么问题？](https://xiaolinnote.com/ai/rag/2_rag_problems.html)
- [下一页 4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？](https://xiaolinnote.com/ai/rag/4_chunking.html)
