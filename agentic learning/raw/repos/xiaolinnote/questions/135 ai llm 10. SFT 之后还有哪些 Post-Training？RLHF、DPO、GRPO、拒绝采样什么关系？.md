...
created: 2026-05-17
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/llm/post_training.html"
source: "https://xiaolinnote.com/ai/llm/post_training.html"
last_checked: 2026-05-17
freshness: watch
sha256: 1566e26266ceb8dc83ba900ca64a7d534318b4158b24d4b614194bc0370cbb3c
related:
...
原始链接：https://xiaolinnote.com/ai/llm/post_training.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)[[LLM]]大约 17 分钟约 5182 字

---

# [10. SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒绝采样什么关系？](#_10-sft-之后还有哪些-post-training-rlhf、dpo、grpo、拒绝采样什么关系)
...
### [Post-Training 是什么概念？为什么 SFT 之后还需要它](#post-training-是什么概念-为什么-sft-之后还需要它)
...
### [RLHF：经典方案，4 模型架构](#rlhf-经典方案-4-模型架构)
...
### [DPO：绕过奖励模型的等价转换](#dpo-绕过奖励模型的等价转换)
...
### [GRPO：砍掉 Value Model 的 PPO 进化版](#grpo-砍掉-value-model-的-ppo-进化版)
...
### [拒绝采样：简单粗暴的迭代式 SFT](#拒绝采样-简单粗暴的迭代式-sft)
...
### [RLAIF：让强 AI 当老师](#rlaif-让强-ai-当老师)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/post_training.html#main-content)
...
- [10. SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒绝采样什么关系？](https://xiaolinnote.com/ai/llm/post_training.html#_10-sft-之后还有哪些-post-training-rlhf、dpo、grpo、拒绝采样什么关系)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/post_training.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/post_training.html#📝-详细解析)
- [Post-Training 是什么概念？为什么 SFT 之后还需要它](https://xiaolinnote.com/ai/llm/post_training.html#post-training-是什么概念-为什么-sft-之后还需要它)
- [RLHF：经典方案，4 模型架构](https://xiaolinnote.com/ai/llm/post_training.html#rlhf-经典方案-4-模型架构)
- [DPO：绕过奖励模型的等价转换](https://xiaolinnote.com/ai/llm/post_training.html#dpo-绕过奖励模型的等价转换)
- [GRPO：砍掉 Value Model 的 PPO 进化版](https://xiaolinnote.com/ai/llm/post_training.html#grpo-砍掉-value-model-的-ppo-进化版)
- [拒绝采样：简单粗暴的迭代式 SFT](https://xiaolinnote.com/ai/llm/post_training.html#拒绝采样-简单粗暴的迭代式-sft)
- [RLAIF：让强 AI 当老师](https://xiaolinnote.com/ai/llm/post_training.html#rlaif-让强-ai-当老师)
- [五类方案对比表](https://xiaolinnote.com/ai/llm/post_training.html#五类方案对比表)
- [实际工程怎么组合使用](https://xiaolinnote.com/ai/llm/post_training.html#实际工程怎么组合使用)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/post_training.html#🎯-面试总结)
- [上一页 9. 请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？](https://xiaolinnote.com/ai/llm/lora.html)
- [下一页 11. 大模型的 DPO 和 PPO 的区别是什么？](https://xiaolinnote.com/ai/llm/dpo_vs_ppo.html)
