...
created: 2026-05-07
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/agent/4_patterns.html"
source: "https://xiaolinnote.com/ai/agent/4_patterns.html"
last_checked: 2026-05-17
freshness: watch
sha256: ea2453fd1a1a84de890f10e7576463da89a35dff15a54ae8d92a6bc52d79526c
related:
...
# 4. 了解哪些其他的 Agent 设计范式？Agent 和 [[Agent Workflow|Workflow]]的区别是什么？

原始链接：https://xiaolinnote.com/ai/agent/4_patterns.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 11 分钟约 3379 字

---

# [4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？](#_4-了解哪些其他的-agent-设计范式-agent-和-workflow的区别是什么)
...
### [Workflow 和 Agent 的区别](#workflow-和-agent-的区别)
...
不过 ReAct 也有一个明显的短板：它是「走一步看一步」的模式，每一步都是局部最优决策，处理特别复杂的、需要全局[[Planning|规划]]的任务时，容易在中间迷失方向。比如一个需要十几步才能完成的研究任务，ReAct 可能做到第五步就忘了最初的目标是什么，或者反复在几个工具之间打转。
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/4_patterns.html#main-content)
...
- [4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？](https://xiaolinnote.com/ai/agent/4_patterns.html#_4-了解哪些其他的-agent-设计范式-agent-和-workflow的区别是什么)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/4_patterns.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/4_patterns.html#📝-详细解析)
- [Workflow 和 Agent 的区别](https://xiaolinnote.com/ai/agent/4_patterns.html#workflow-和-agent-的区别)
- [Agent 三种设计范式](https://xiaolinnote.com/ai/agent/4_patterns.html#agent-三种设计范式)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/4_patterns.html#🎯-面试总结)
- [上一页 3. Workflow，Agent，Tools 这三个的概念和区别介绍一下？](https://xiaolinnote.com/ai/agent/3_workflow_tools.html)
- [下一页 5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？](https://xiaolinnote.com/ai/agent/5_react.html)
