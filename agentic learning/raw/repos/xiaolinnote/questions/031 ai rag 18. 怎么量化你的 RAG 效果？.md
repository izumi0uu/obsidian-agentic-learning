...
created: 2026-05-07
updated: 2026-05-16
url: "https://xiaolinnote.com/ai/rag/18_evaluation.html"
source: "https://xiaolinnote.com/ai/rag/18_evaluation.html"
last_checked: 2026-05-07
freshness: watch
sha256: 4b1d0d00d55e5ccdf6a9851da857ae230d14fe2ade1c8bd98a955c6cf3cdeebf
related:
...
原始链接：https://xiaolinnote.com/ai/rag/18_evaluation.html
...
[公众号@小林面试笔记](https://xiaolinnote.com)大约 12 分钟约 3517 字
...
👔面试官：靠用户投诉来[[Evaluation|评估]]？那你等到用户投诉的时候，已经有多少人被错误答案坑过了？你这叫亡羊补牢，不叫效果评估。再说，用户不投诉不代表效果好，可能人家直接就不用了。
...
### [什么是 RAG 评估？](#什么是-rag-评估)

[[RAG Evaluation|RAG 评估]]，就是用一套可量化的指标体系，持续测量 RAG 系统「回答得好不好」，并且能把「好不好」这个笼统的感受，拆解成具体是哪个环节出了问题。
...
![](https://cdn.xiaolincoding.com//picgo/1776839015109-d0c9ce3a-313d-4897-a8f4-4acde911abab.png)
...
### [第二层：生成层评估（RAGAs 框架）](#第二层-生成层评估-ragas-框架)

检索层评估回答了「找没找到」的问题，但找到之后 LLM 有没有好好利用这些内容？这就需要生成层评估。RAGAs（Retrieval Augmented Generation Assessment）是目前使用很广泛的 RAG 端到端评估框架，它的核心思路叫做「[[LLM-as-Judge|LLM-as-a-Judge]]」，意思是用 LLM 来当裁判，自动给答案打分，不需要人工标注每一条，大幅降低评估成本。
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/18_evaluation.html#main-content)
...
- [18. 怎么量化你的 RAG 效果？](https://xiaolinnote.com/ai/rag/18_evaluation.html#_18-怎么量化你的-rag-效果)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/18_evaluation.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/18_evaluation.html#📝-详细解析)
- [什么是 RAG 评估？](https://xiaolinnote.com/ai/rag/18_evaluation.html#什么是-rag-评估)
- [为什么需要 RAG 评估？](https://xiaolinnote.com/ai/rag/18_evaluation.html#为什么需要-rag-评估)
- [为什么 RAG 评估很难](https://xiaolinnote.com/ai/rag/18_evaluation.html#为什么-rag-评估很难)
- [第一层：检索层评估](https://xiaolinnote.com/ai/rag/18_evaluation.html#第一层-检索层评估)
- [第二层：生成层评估（RAGAs 框架）](https://xiaolinnote.com/ai/rag/18_evaluation.html#第二层-生成层评估-ragas-框架)
- [通过指标定位问题](https://xiaolinnote.com/ai/rag/18_evaluation.html#通过指标定位问题)
- [线上指标：最终衡量标准](https://xiaolinnote.com/ai/rag/18_evaluation.html#线上指标-最终衡量标准)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/18_evaluation.html#🎯-面试总结)
- [上一页 17. 如何规避 RAG 系统中大模型的幻觉？](https://xiaolinnote.com/ai/rag/17_hallucination.html)
- [下一页 19. RAG 知识库如何实现动态与持续更新？](https://xiaolinnote.com/ai/rag/19_dynamic_update.html)
