...
👔面试官：说说 Agent [[Tool Use|Skill]] 是什么？
...
### [为什么需要 Skill？从「重复贴 prompt」的痛点说起](#为什么需要-skill-从「重复贴-prompt」的痛点说起)
...
### [渐进式加载：Skill 最聪明的设计](#渐进式加载-skill-最聪明的设计)
...
### [Skill 和 Tool、Prompt 分别是什么关系](#skill-和-tool、prompt-分别是什么关系)

这三个概念经常被混淆，但它们处于完全不同的层次，用一个类比就能讲清楚。

![](https://cdn.xiaolincoding.com//picgo/image-20260410194032993.png)

你可以把 [[Tool Calling|Tool]]（包括 MCP 工具）想象成公司给员工配的电脑、软件和数据库访问权限。有了 Tool，Agent 就能「做事」，比如查数据库、调 API、读写文件。但光有工具不够，你给一个新人配了一台电脑和所有系统权限，他也不知道该按什么流程做代码审查，不知道先查什么、后查什么、用什么格式输出报告。
...
### [Skill 从 Anthropic 走向开放标准](#skill-从-anthropic-走向开放标准)
...
- [跳至主要內容](https://xiaolinnote.com/ai/tools/9_skill.html#main-content)
...
- [9. Skill 是什么？](https://xiaolinnote.com/ai/tools/9_skill.html#_9-skill-是什么)
- [💡 简要回答](https://xiaolinnote.com/ai/tools/9_skill.html#💡-简要回答)
- [SKILL.md](http://SKILL.md)
- [📝 详细解析](https://xiaolinnote.com/ai/tools/9_skill.html#📝-详细解析)
- [为什么需要 Skill？从「重复贴 prompt」的痛点说起](https://xiaolinnote.com/ai/tools/9_skill.html#为什么需要-skill-从「重复贴-prompt」的痛点说起)
- [Skill 的结构长什么样](https://xiaolinnote.com/ai/tools/9_skill.html#skill-的结构长什么样)
- [渐进式加载：Skill 最聪明的设计](https://xiaolinnote.com/ai/tools/9_skill.html#渐进式加载-skill-最聪明的设计)
- [Skill 和 Tool、Prompt 分别是什么关系](https://xiaolinnote.com/ai/tools/9_skill.html#skill-和-tool、prompt-分别是什么关系)
- [Skill 从 Anthropic 走向开放标准](https://xiaolinnote.com/ai/tools/9_skill.html#skill-从-anthropic-走向开放标准)
- [claude.ai](http://claude.ai)
- [🎯 面试总结](https://xiaolinnote.com/ai/tools/9_skill.html#🎯-面试总结)
- [上一页 8. 为什么有些特定的推理模型不支持 MCP 协议？](https://xiaolinnote.com/ai/tools/8_reasoning_no_mcp.html)
- [下一页 10. MCP 和 Agent Skill 的区别是什么？](https://xiaolinnote.com/ai/tools/10_mcp_vs_skill.html)
