...
# 8. 请你介绍一下 AI Agent 的[[Memory|记忆]]机制，并说明在实际开发中应该如何设计记忆模块？

原始链接：https://xiaolinnote.com/ai/agent/8_memory.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 22 分钟约 6626 字

---

# [8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？](#_8-请你介绍一下-ai-agent-的记忆机制-并说明在实际开发中应该如何设计记忆模块)

👔面试官：你来讲讲 Agent 的记忆机制，分哪几种，各自有什么作用？

🙋‍♂️我：有短期记忆和[[Long-term Memory|长期记忆]]……短期就是当前对话历史，长期就是存到数据库里的内容？
...
### [没有记忆的 Agent 有多不好用](#没有记忆的-agent-有多不好用)
...
### [四种记忆类型（从最短暂到最持久）](#四种记忆类型-从最短暂到最持久)
...
第二种是「[[Semantic Memory|语义记忆]]」（Semantic Memory），存的是从多次经历中提炼出来的通用知识和规律。比如经历了好几次反爬问题之后，Agent 沉淀出一条规律：「当目标网站有 JavaScript 动态渲染时，requests 库抓不到内容，应该优先考虑 Selenium 或 Playwright」。这不再是某一次具体的事件记录，而是跨多次经验总结出来的抽象知识。语义记忆的信息密度更高，检索时也更容易命中，因为它直接存储的就是结论而不是过程。
...
### [实际设计记忆模块的三个核心问题](#实际设计记忆模块的三个核心问题)
...
### [Context Window 管理：短期记忆的「工作台」不够大怎么办](#context-window-管理-短期记忆的「工作台」不够大怎么办)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/8_memory.html#main-content)
...
- [8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？](https://xiaolinnote.com/ai/agent/8_memory.html#_8-请你介绍一下-ai-agent-的记忆机制-并说明在实际开发中应该如何设计记忆模块)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/8_memory.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/8_memory.html#📝-详细解析)
- [没有记忆的 Agent 有多不好用](https://xiaolinnote.com/ai/agent/8_memory.html#没有记忆的-agent-有多不好用)
- [四种记忆类型（从最短暂到最持久）](https://xiaolinnote.com/ai/agent/8_memory.html#四种记忆类型-从最短暂到最持久)
- [实际设计记忆模块的三个核心问题](https://xiaolinnote.com/ai/agent/8_memory.html#实际设计记忆模块的三个核心问题)
- [Context Window 管理：短期记忆的「工作台」不够大怎么办](https://xiaolinnote.com/ai/agent/8_memory.html#context-window-管理-短期记忆的「工作台」不够大怎么办)
- [知识图谱：让记忆之间产生关联](https://xiaolinnote.com/ai/agent/8_memory.html#知识图谱-让记忆之间产生关联)
- [记忆整合：从碎片到知识](https://xiaolinnote.com/ai/agent/8_memory.html#记忆整合-从碎片到知识)
- [完整记忆模块的配合方式](https://xiaolinnote.com/ai/agent/8_memory.html#完整记忆模块的配合方式)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/8_memory.html#🎯-面试总结)
- [上一页 7. 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？](https://xiaolinnote.com/ai/agent/7_tasksplit.html)
- [下一页 9. Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？](https://xiaolinnote.com/ai/agent/9_memory_storage.html)
