...
created: 2026-05-17
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/llm/decoding_strategies.html"
source: "https://xiaolinnote.com/ai/llm/decoding_strategies.html"
last_checked: 2026-05-17
freshness: watch
sha256: 3a9432ae627b3812d3932fd79f5ce5caf8e18aca728454febb9a228c9960bf97
related:
...
# 12. [[LLM|大模型]]生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？

原始链接：https://xiaolinnote.com/ai/llm/decoding_strategies.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 15 分钟约 4480 字

---

# [12. 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？](#_12-大模型生成文本时的解码策略有哪些-贪心、beam-search、采样分别什么时候用)
...
### [解码策略的本质：从概率分布里选下一个 token](#解码策略的本质-从概率分布里选下一个-token)
...
### [Beam Search：翻译时代的王者](#beam-search-翻译时代的王者)
...
### [为什么 LLM 时代 Beam Search 失宠了](#为什么-llm-时代-beam-search-失宠了)
...
### [进阶策略：推测解码与 Self-Consistency](#进阶策略-推测解码与-self-consistency)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/decoding_strategies.html#main-content)
...
- [12. 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？](https://xiaolinnote.com/ai/llm/decoding_strategies.html#_12-大模型生成文本时的解码策略有哪些-贪心、beam-search、采样分别什么时候用)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/decoding_strategies.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/decoding_strategies.html#📝-详细解析)
- [解码策略的本质：从概率分布里选下一个 token](https://xiaolinnote.com/ai/llm/decoding_strategies.html#解码策略的本质-从概率分布里选下一个-token)
- [贪心解码：最简单也最容易踩坑](https://xiaolinnote.com/ai/llm/decoding_strategies.html#贪心解码-最简单也最容易踩坑)
- [Beam Search：翻译时代的王者](https://xiaolinnote.com/ai/llm/decoding_strategies.html#beam-search-翻译时代的王者)
- [为什么 LLM 时代 Beam Search 失宠了](https://xiaolinnote.com/ai/llm/decoding_strategies.html#为什么-llm-时代-beam-search-失宠了)
- [采样族：用随机性换多样性](https://xiaolinnote.com/ai/llm/decoding_strategies.html#采样族-用随机性换多样性)
- [实际选型：什么任务用什么策略](https://xiaolinnote.com/ai/llm/decoding_strategies.html#实际选型-什么任务用什么策略)
- [进阶策略：推测解码与 Self-Consistency](https://xiaolinnote.com/ai/llm/decoding_strategies.html#进阶策略-推测解码与-self-consistency)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/decoding_strategies.html#🎯-面试总结)
- [上一页 11. 大模型的 DPO 和 PPO 的区别是什么？](https://xiaolinnote.com/ai/llm/dpo_vs_ppo.html)
- [下一页 13. 大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是什么？](https://xiaolinnote.com/ai/llm/temperature_top_p_top_k.html)
