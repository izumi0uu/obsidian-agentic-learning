...
👔面试官：详细说说大模型的 [[Tool Calling|Function Call]] 能力是怎么训练出来的？
...
👔面试官：单工具调用只是最基础的场景。多工具并行调用、工具调用失败后重试、不需要工具直接回答、多轮对话中的工具调用，这些场景训练数据里都要覆盖到，缺一个就会在对应场景翻车。而且你还是只提了 SFT，[[LLM Training Pipeline|RLHF]] 阶段怎么解决「该不该调」的边界感问题，训练数据从哪来，这些关键环节一个都没讲到，回去好好整理一下。
...
### [阶段一：SFT，让模型「学会怎么调」](#阶段一-sft-让模型「学会怎么调」)
...
### [阶段二：RLHF，对齐「该不该调」的边界感](#阶段二-rlhf-对齐「该不该调」的边界感)
...
#### [RLAIF：用 AI 代替人工打分](#rlaif-用-ai-代替人工打分)
...
- [跳至主要內容](https://xiaolinnote.com/ai/tools/3_fc_training.html#main-content)
...
- [3. 大模型的 Function Call 能力是怎么训练出来的？](https://xiaolinnote.com/ai/tools/3_fc_training.html#_3-大模型的-function-call-能力是怎么训练出来的)
- [💡 简要回答](https://xiaolinnote.com/ai/tools/3_fc_training.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/tools/3_fc_training.html#📝-详细解析)
- [阶段一：SFT，让模型「学会怎么调」](https://xiaolinnote.com/ai/tools/3_fc_training.html#阶段一-sft-让模型「学会怎么调」)
- [训练数据需要覆盖哪些场景](https://xiaolinnote.com/ai/tools/3_fc_training.html#训练数据需要覆盖哪些场景)
- [训练数据从哪来](https://xiaolinnote.com/ai/tools/3_fc_training.html#训练数据从哪来)
- [阶段二：RLHF，对齐「该不该调」的边界感](https://xiaolinnote.com/ai/tools/3_fc_training.html#阶段二-rlhf-对齐「该不该调」的边界感)
- [RLAIF：用 AI 代替人工打分](https://xiaolinnote.com/ai/tools/3_fc_training.html#rlaif-用-ai-代替人工打分)
- [两个阶段各司其职](https://xiaolinnote.com/ai/tools/3_fc_training.html#两个阶段各司其职)
- [🎯 面试总结](https://xiaolinnote.com/ai/tools/3_fc_training.html#🎯-面试总结)
- [上一页 2. LLM 是如何学会调用外部工具的？](https://xiaolinnote.com/ai/tools/2_llm_tool_learning.html)
- [下一页 4. 什么是 MCP（模型上下文协议）？讲讲它的核心内容？](https://xiaolinnote.com/ai/tools/4_what_is_mcp.html)
