...
### [策略一：固定大小切割（Fixed Size Chunking）](#策略一-固定大小切割-fixed-size-chunking)
...
### [策略二：语义边界切割（Semantic/Structure Based Chunking）](#策略二-语义边界切割-semantic-structure-based-chunking)
...
### [策略四：父子切割（Parent-Child Chunking）](#策略四-父子切割-parent-child-chunking)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/4_chunking.html#main-content)
...
- [4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？](https://xiaolinnote.com/ai/rag/4_chunking.html#_4-rag-中的文档是怎么存的-粒度是多大-详细说说文档切割-chunking-策略)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/4_chunking.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/4_chunking.html#📝-详细解析)
- [文档是怎么存的？](https://xiaolinnote.com/ai/rag/4_chunking.html#文档是怎么存的)
- [粒度怎么定?](https://xiaolinnote.com/ai/rag/4_chunking.html#粒度怎么定)
- [文档切割策略有哪些？](https://xiaolinnote.com/ai/rag/4_chunking.html#文档切割策略有哪些)
- [策略一：固定大小切割（Fixed Size Chunking）](https://xiaolinnote.com/ai/rag/4_chunking.html#策略一-固定大小切割-fixed-size-chunking)
- [策略二：语义边界切割（Semantic/Structure Based Chunking）](https://xiaolinnote.com/ai/rag/4_chunking.html#策略二-语义边界切割-semantic-structure-based-chunking)
- [策略三：特殊内容专项处理](https://xiaolinnote.com/ai/rag/4_chunking.html#策略三-特殊内容专项处理)
- [策略四：父子切割（Parent-Child Chunking）](https://xiaolinnote.com/ai/rag/4_chunking.html#策略四-父子切割-parent-child-chunking)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/4_chunking.html#🎯-面试总结)
- [上一页 3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html)
- [下一页 5. 怎么规避语义被切割掉的问题？](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html)
