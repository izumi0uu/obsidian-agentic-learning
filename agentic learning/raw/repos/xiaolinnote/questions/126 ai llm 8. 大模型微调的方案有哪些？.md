...
原始链接：https://xiaolinnote.com/ai/llm/finetuning.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 14 分钟约 4210 字

---

# [8. 大模型微调的方案有哪些？](#_8-大模型微调的方案有哪些)
...
### [先回答一个前置问题：什么时候才真的需要微调？](#先回答一个前置问题-什么时候才真的需要微调)
...
### [微调的两个正交维度：改哪些参数 vs 学什么目标](#微调的两个正交维度-改哪些参数-vs-学什么目标)
...
### [「改哪些参数」维度：从全量微调到 QLoRA](#「改哪些参数」维度-从全量微调到-qlora)
...
### [「学什么目标」维度：SFT 和 DPO](#「学什么目标」维度-sft-和-dpo)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/finetuning.html#main-content)
...
- [8. 大模型微调的方案有哪些？](https://xiaolinnote.com/ai/llm/finetuning.html#_8-大模型微调的方案有哪些)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/finetuning.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/finetuning.html#📝-详细解析)
- [先回答一个前置问题：什么时候才真的需要微调？](https://xiaolinnote.com/ai/llm/finetuning.html#先回答一个前置问题-什么时候才真的需要微调)
- [微调的两个正交维度：改哪些参数 vs 学什么目标](https://xiaolinnote.com/ai/llm/finetuning.html#微调的两个正交维度-改哪些参数-vs-学什么目标)
- [「改哪些参数」维度：从全量微调到 QLoRA](https://xiaolinnote.com/ai/llm/finetuning.html#「改哪些参数」维度-从全量微调到-qlora)
- [「学什么目标」维度：SFT 和 DPO](https://xiaolinnote.com/ai/llm/finetuning.html#「学什么目标」维度-sft-和-dpo)
- [实战选型怎么落地](https://xiaolinnote.com/ai/llm/finetuning.html#实战选型怎么落地)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/finetuning.html#🎯-面试总结)
- [上一页 7. 什么是 Scaling Law？大模型的「涌现能力」是怎么回事？](https://xiaolinnote.com/ai/llm/scaling_law_emergence.html)
- [下一页 9. 请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？](https://xiaolinnote.com/ai/llm/lora.html)
