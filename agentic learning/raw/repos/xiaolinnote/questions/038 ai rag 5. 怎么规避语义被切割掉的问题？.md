...
### [方案一：重叠切割（Overlap）](#方案一-重叠切割-overlap)
...
### [方案三：句子窗口检索（Sentence Window Retrieval）](#方案三-句子窗口检索-sentence-window-retrieval)
...
### [方案四：父子切割（Parent-Child Chunking）](#方案四-父子切割-parent-child-chunking)
...
### [方案五：命题化切割（Propositions-based Chunking）](#方案五-命题化切割-propositions-based-chunking)
...
### [方案六：Contextual Retrieval（Anthropic）](#方案六-contextual-retrieval-anthropic)
...
### [成本控制：用 Prompt Caching 大幅降低 LLM 调用费用](#成本控制-用-prompt-caching-大幅降低-llm-调用费用)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#main-content)
...
- [5. 怎么规避语义被切割掉的问题？](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#_5-怎么规避语义被切割掉的问题)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#📝-详细解析)
- [语义被切割是什么问题?](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#语义被切割是什么问题)
- [方案一：重叠切割（Overlap）](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案一-重叠切割-overlap)
- [方案二：按语义边界切割](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案二-按语义边界切割)
- [方案三：句子窗口检索（Sentence Window Retrieval）](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案三-句子窗口检索-sentence-window-retrieval)
- [方案四：父子切割（Parent-Child Chunking）](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案四-父子切割-parent-child-chunking)
- [方案五：命题化切割（Propositions-based Chunking）](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案五-命题化切割-propositions-based-chunking)
- [方案六：Contextual Retrieval（Anthropic）](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#方案六-contextual-retrieval-anthropic)
- [成本控制：用 Prompt Caching 大幅降低 LLM 调用费用](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#成本控制-用-prompt-caching-大幅降低-llm-调用费用)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html#🎯-面试总结)
- [上一页 4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？](https://xiaolinnote.com/ai/rag/4_chunking.html)
- [下一页 6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](https://xiaolinnote.com/ai/rag/6_embedding.html)
