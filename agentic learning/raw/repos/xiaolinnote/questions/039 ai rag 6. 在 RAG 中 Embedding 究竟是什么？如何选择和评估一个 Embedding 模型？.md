...
freshness: watch
sha256: 381a435656e31d008f349095abdb91e50a58eaa316bc7ec96fe9c6e86a2d1e06
related:
...
原始链接：https://xiaolinnote.com/ai/rag/6_embedding.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)RAG大约 8 分钟约 2453 字

---

# [6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](#_6-在-rag-中-embedding-究竟是什么-如何选择和评估一个-embedding-模型)
...
### [常见 Embedding 模型对比](#常见-embedding-模型对比)
...
### [如何评估 Embedding 模型？](#如何评估-embedding-模型)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/6_embedding.html#main-content)
...
- [6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](https://xiaolinnote.com/ai/rag/6_embedding.html#_6-在-rag-中-embedding-究竟是什么-如何选择和评估一个-embedding-模型)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/6_embedding.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/6_embedding.html#📝-详细解析)
- [Embedding 是什么?](https://xiaolinnote.com/ai/rag/6_embedding.html#embedding-是什么)
- [常见 Embedding 模型对比](https://xiaolinnote.com/ai/rag/6_embedding.html#常见-embedding-模型对比)
- [如何选择 Embedding 模型？](https://xiaolinnote.com/ai/rag/6_embedding.html#如何选择-embedding-模型)
- [如何评估 Embedding 模型？](https://xiaolinnote.com/ai/rag/6_embedding.html#如何评估-embedding-模型)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/6_embedding.html#🎯-面试总结)
- [上一页 5. 怎么规避语义被切割掉的问题？](https://xiaolinnote.com/ai/rag/5_semantic_cuts.html)
- [下一页 7. Embedding 有哪几种算法你了解过吗？](https://xiaolinnote.com/ai/rag/7_embedding_algos.html)
