...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/llm_training.html
source: https://xiaolinnote.com/ai/llm/llm_training.html
last_checked: 2026-05-17
freshness: watch
sha256: c26bd6979ee29ef4906bdcc2809820dbc3e7372b8218e40202e9ffce375b83c6
related:
...
原始链接：https://xiaolinnote.com/ai/llm/llm_training.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 13 分钟约 3836 字

---

# [6. 大模型是怎么训练出来的？](#_6-大模型是怎么训练出来的)
...
### [先理一个直觉：训练大模型为什么要分阶段？](#先理一个直觉-训练大模型为什么要分阶段)
...
### [第二阶段：SFT，从「续写机器」变「对话机器」](#第二阶段-sft-从「续写机器」变「对话机器」)
...
### [第三阶段：对齐，学会「好好说话」](#第三阶段-对齐-学会「好好说话」)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/llm_training.html#main-content)
...
- [6. 大模型是怎么训练出来的？](https://xiaolinnote.com/ai/llm/llm_training.html#_6-大模型是怎么训练出来的)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/llm_training.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/llm_training.html#📝-详细解析)
- [先理一个直觉：训练大模型为什么要分阶段？](https://xiaolinnote.com/ai/llm/llm_training.html#先理一个直觉-训练大模型为什么要分阶段)
- [第一阶段：预训练，读万卷书](https://xiaolinnote.com/ai/llm/llm_training.html#第一阶段-预训练-读万卷书)
- [第二阶段：SFT，从「续写机器」变「对话机器」](https://xiaolinnote.com/ai/llm/llm_training.html#第二阶段-sft-从「续写机器」变「对话机器」)
- [第三阶段：对齐，学会「好好说话」](https://xiaolinnote.com/ai/llm/llm_training.html#第三阶段-对齐-学会「好好说话」)
- [三阶段为什么缺一不可](https://xiaolinnote.com/ai/llm/llm_training.html#三阶段为什么缺一不可)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/llm_training.html#🎯-面试总结)
- [上一页 5. 什么是大模型项目的分词器？原理是什么？](https://xiaolinnote.com/ai/llm/tokenizer.html)
- [下一页 7. 什么是 Scaling Law？大模型的「涌现能力」是怎么回事？](https://xiaolinnote.com/ai/llm/scaling_law_emergence.html)
