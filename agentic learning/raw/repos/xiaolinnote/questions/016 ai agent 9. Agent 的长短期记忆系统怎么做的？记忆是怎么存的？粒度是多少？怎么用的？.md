...
created: 2026-05-07
updated: 2026-05-17
url: https://xiaolinnote.com/ai/agent/9_memory_storage.html
source: https://xiaolinnote.com/ai/agent/9_memory_storage.html
last_checked: 2026-05-17
freshness: watch
sha256: 9241a14d4589640d70e35fe4128c39f1e671c75f0e749b309133d32cbfc48d38
related:
...
# 9. Agent 的长短期[[Memory|记忆系统]]怎么做的？记忆是怎么存的？粒度是多少？怎么用的？

原始链接：https://xiaolinnote.com/ai/agent/9_memory_storage.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 15 分钟约 4439 字

---

# [9. Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？](#_9-agent-的长短期记忆系统怎么做的-记忆是怎么存的-粒度是多少-怎么用的)

👔面试官：你们项目里 Agent 的记忆系统是怎么做的，短期记忆和[[Long-term Memory|长期记忆]]分别存在哪？
...
短期记忆就是 context window 里的对话历史，存当前任务的中间状态，任务结束就清掉；长期记忆用[[Vector Database|向量数据库]]存，把信息 embedding 后写入，用的时候做语义检索拿回来注入 prompt。
...
第一种是**[[Semantic Memory|语义记忆]]**（Semantic Memory），存的是事实性知识，比如「用户是 Python 开发者」「项目预算上限 5 万」，这些是不随时间变化的客观信息。
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/9_memory_storage.html#main-content)
...
- [9. Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？](https://xiaolinnote.com/ai/agent/9_memory_storage.html#_9-agent-的长短期记忆系统怎么做的-记忆是怎么存的-粒度是多少-怎么用的)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/9_memory_storage.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/9_memory_storage.html#📝-详细解析)
- [短期记忆](https://xiaolinnote.com/ai/agent/9_memory_storage.html#短期记忆)
- [长期记忆](https://xiaolinnote.com/ai/agent/9_memory_storage.html#长期记忆)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/9_memory_storage.html#🎯-面试总结)
- [上一页 8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？](https://xiaolinnote.com/ai/agent/8_memory.html)
- [下一页 10. 什么是 Multi-Agent？](https://xiaolinnote.com/ai/agent/10_multiagent.html)
