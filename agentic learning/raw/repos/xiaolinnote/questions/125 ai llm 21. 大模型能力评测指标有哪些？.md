...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/evaluation_metrics.html
source: https://xiaolinnote.com/ai/llm/evaluation_metrics.html
last_checked: 2026-05-17
freshness: watch
sha256: fe8b9ac359e5a82ced72c92026d777c24e084f293c1f3dcc34c532b156c0d464
related:
...
# 21. [[LLM|大模型]]能力评测指标有哪些？

原始链接：https://xiaolinnote.com/ai/llm/evaluation_metrics.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 8 分钟约 2371 字

---

# [21. 大模型能力评测指标有哪些？](#_21-大模型能力评测指标有哪些)
...
### [主流学术 Benchmark 逐一介绍](#主流学术-benchmark-逐一介绍)
...
### [Benchmark 的局限性：数据污染问题](#benchmark-的局限性-数据污染问题)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#main-content)
...
- [21. 大模型能力评测指标有哪些？](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#_21-大模型能力评测指标有哪些)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#📝-详细解析)
- [为什么需要评测指标](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#为什么需要评测指标)
- [主流学术 Benchmark 逐一介绍](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#主流学术-benchmark-逐一介绍)
- [Benchmark 的局限性：数据污染问题](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#benchmark-的局限性-数据污染问题)
- [如何建自己的业务评估集](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#如何建自己的业务评估集)
- [离线评估 + 线上指标的闭环](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#离线评估-线上指标的闭环)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/evaluation_metrics.html#🎯-面试总结)
- [上一页 20. 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？](https://xiaolinnote.com/ai/llm/deployment_frameworks.html)
- [下一页 22. 对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？](https://xiaolinnote.com/ai/llm/model_selection.html)
