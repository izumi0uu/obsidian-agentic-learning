...
created: 2026-05-17
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/llm/moe.html"
source: "https://xiaolinnote.com/ai/llm/moe.html"
last_checked: 2026-05-17
freshness: watch
sha256: c2306359b723d39c286a737668202ac29f4f5e5d21065a60c76fbe73d3c06c47
related:
...
原始链接：https://xiaolinnote.com/ai/llm/moe.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)[[LLM]]大约 16 分钟约 4739 字

---

# [19. MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？](#_19-moe-混合专家模型是什么-deepseek-v3、qwen-为什么用-moe)
...
### [MoE 是什么？为什么 Dense 模型不够用了](#moe-是什么-为什么-dense-模型不够用了)
...
### [总参数 vs 激活参数：MoE 的设计哲学](#总参数-vs-激活参数-moe-的设计哲学)
...
### [主流 MoE 模型对比：DeepSeek V3、Mixtral、Qwen 各自的设计](#主流-moe-模型对比-deepseek-v3、mixtral、qwen-各自的设计)
...
### [为什么 2024 年后 MoE 才在 LLM 领域火起来](#为什么-2024-年后-moe-才在-llm-领域火起来)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/moe.html#main-content)
...
- [19. MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？](https://xiaolinnote.com/ai/llm/moe.html#_19-moe-混合专家模型是什么-deepseek-v3、qwen-为什么用-moe)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/moe.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/moe.html#📝-详细解析)
- [MoE 是什么？为什么 Dense 模型不够用了](https://xiaolinnote.com/ai/llm/moe.html#moe-是什么-为什么-dense-模型不够用了)
- [MoE 的三个核心组件](https://xiaolinnote.com/ai/llm/moe.html#moe-的三个核心组件)
- [总参数 vs 激活参数：MoE 的设计哲学](https://xiaolinnote.com/ai/llm/moe.html#总参数-vs-激活参数-moe-的设计哲学)
- [主流 MoE 模型对比：DeepSeek V3、Mixtral、Qwen 各自的设计](https://xiaolinnote.com/ai/llm/moe.html#主流-moe-模型对比-deepseek-v3、mixtral、qwen-各自的设计)
- [MoE 的三大训练挑战](https://xiaolinnote.com/ai/llm/moe.html#moe-的三大训练挑战)
- [MoE 的部署挑战](https://xiaolinnote.com/ai/llm/moe.html#moe-的部署挑战)
- [为什么 2024 年后 MoE 才在 LLM 领域火起来](https://xiaolinnote.com/ai/llm/moe.html#为什么-2024-年后-moe-才在-llm-领域火起来)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/moe.html#🎯-面试总结)
- [上一页 18. 大模型为什么会出现幻觉？怎么缓解？](https://xiaolinnote.com/ai/llm/hallucination.html)
- [下一页 20. 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？](https://xiaolinnote.com/ai/llm/deployment_frameworks.html)
