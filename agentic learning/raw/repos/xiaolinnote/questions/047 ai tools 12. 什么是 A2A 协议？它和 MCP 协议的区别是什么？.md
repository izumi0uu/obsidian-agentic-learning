...
# 12. 什么是 [[A2A|A2A 协议]]？它和 [[MCP]] 协议的区别是什么？
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)Tools大约 9 分钟约 2848 字

---

# [12. 什么是 A2A 协议？它和 MCP 协议的区别是什么？](#_12-什么是-a2a-协议-它和-mcp-协议的区别是什么)
...
调度 Agent 的上下文里只多了一份摘要，而不是几十个网页的原文。这就把「调研过程」的上下文压力隔离在了市场 Agent 内部，调度 Agent 保持轻量，这是[[Multi-agent Orchestration|多 Agent 协作]]在上下文层面的核心收益。
