...
freshness: watch
sha256: 8c0ea5fcb9ce36d0288e8c1b2c469256ec9de0a9be454b108cbb8ab5da9f48a0
related:
...
原始链接：https://xiaolinnote.com/ai/tools/12_a2a_protocol.html
...
[公众号@小林面试笔记](https://xiaolinnote.com)大约 9 分钟约 2847 字
...
👔面试官：A2A 全称是 [[A2A|Agent-to-Agent]]，注意看名字，是 Agent 到 Agent，不是 Agent 到工具。MCP 是 Agent 连工具和数据，A2A 是多个 Agent 之间互相通信协作。一个向下连工具，一个向外连 Agent，方向完全不同。你再想想，为什么需要多个 Agent 协作，单个 Agent 不够用吗？
...
两者是互补的，不冲突：MCP 向下连工具，A2A 向上连 Agent，在复杂的[[Multi-agent Orchestration|多 Agent]] 系统里这两个通常都要用到。

## [📝 详细解析](#📝-详细解析)

### [为什么单个 Agent 不够用，上下文和专业边界](#为什么单个-agent-不够用-上下文和专业边界)
...
### [多 Agent 的基础问题，Agent 之间怎么互相认识？](#多-agent-的基础问题-agent-之间怎么互相认识)
...
### [Task，A2A 里的一等公民](#task-a2a-里的一等公民)
...
### [A2A 的架构本质，Agent 的微服务化](#a2a-的架构本质-agent-的微服务化)
...
### [A2A 和 MCP 的关系，一纵一横，各管一层](#a2a-和-mcp-的关系-一纵一横-各管一层)
...
- [跳至主要內容](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#main-content)
...
- [12. 什么是 A2A 协议？它和 MCP 协议的区别是什么？](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#_12-什么是-a2a-协议-它和-mcp-协议的区别是什么)
- [💡 简要回答](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#📝-详细解析)
- [为什么单个 Agent 不够用，上下文和专业边界](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#为什么单个-agent-不够用-上下文和专业边界)
- [多 Agent 的基础问题，Agent 之间怎么互相认识？](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#多-agent-的基础问题-agent-之间怎么互相认识)
- [Task，A2A 里的一等公民](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#task-a2a-里的一等公民)
- [A2A 的架构本质，Agent 的微服务化](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#a2a-的架构本质-agent-的微服务化)
- [A2A 和 MCP 的关系，一纵一横，各管一层](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#a2a-和-mcp-的关系-一纵一横-各管一层)
- [🎯 面试总结](https://xiaolinnote.com/ai/tools/12_a2a_protocol.html#🎯-面试总结)
- [上一页 11. Function Calling、Skill、MCP 这三个有什么区别？](https://xiaolinnote.com/ai/tools/11_fc_skill_mcp.html)
- [下一页 13. MCP 协议通常采用什么通信方式？](https://xiaolinnote.com/ai/tools/13_mcp_transport.html)
