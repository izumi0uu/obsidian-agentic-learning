...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/hallucination.html
source: https://xiaolinnote.com/ai/llm/hallucination.html
last_checked: 2026-05-17
freshness: watch
sha256: d400b1d7e0a096b29053f83127d3409de1cdbe7983d6af41613bf2a69fbe6509
related:
...
# 18. [[LLM|大模型]]为什么会出现幻觉？怎么缓解？

原始链接：https://xiaolinnote.com/ai/llm/hallucination.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 17 分钟约 5193 字

---

# [18. 大模型为什么会出现幻觉？怎么缓解？](#_18-大模型为什么会出现幻觉-怎么缓解)
...
### [幻觉到底是什么？为什么 LLM 必然会幻觉](#幻觉到底是什么-为什么-llm-必然会幻觉)
...
### [根因二：生成机制是「续写」不是「查询」](#根因二-生成机制是「续写」不是「查询」)
...
### [工程实践：为什么幻觉不可能完全消除](#工程实践-为什么幻觉不可能完全消除)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/hallucination.html#main-content)
...
- [18. 大模型为什么会出现幻觉？怎么缓解？](https://xiaolinnote.com/ai/llm/hallucination.html#_18-大模型为什么会出现幻觉-怎么缓解)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/hallucination.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/hallucination.html#📝-详细解析)
- [幻觉到底是什么？为什么 LLM 必然会幻觉](https://xiaolinnote.com/ai/llm/hallucination.html#幻觉到底是什么-为什么-llm-必然会幻觉)
- [根因一：训练数据本身就有错](https://xiaolinnote.com/ai/llm/hallucination.html#根因一-训练数据本身就有错)
- [根因二：生成机制是「续写」不是「查询」](https://xiaolinnote.com/ai/llm/hallucination.html#根因二-生成机制是「续写」不是「查询」)
- [根因三：对齐目标的副作用](https://xiaolinnote.com/ai/llm/hallucination.html#根因三-对齐目标的副作用)
- [三类幻觉的典型表现](https://xiaolinnote.com/ai/llm/hallucination.html#三类幻觉的典型表现)
- [缓解方案：训练层](https://xiaolinnote.com/ai/llm/hallucination.html#缓解方案-训练层)
- [缓解方案：推理层](https://xiaolinnote.com/ai/llm/hallucination.html#缓解方案-推理层)
- [缓解方案：系统层](https://xiaolinnote.com/ai/llm/hallucination.html#缓解方案-系统层)
- [工程实践：为什么幻觉不可能完全消除](https://xiaolinnote.com/ai/llm/hallucination.html#工程实践-为什么幻觉不可能完全消除)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/hallucination.html#🎯-面试总结)
- [上一页 17. 什么是 CoT？为啥效果好？它有什么缺点或局限性？](https://xiaolinnote.com/ai/llm/cot.html)
- [下一页 19. MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？](https://xiaolinnote.com/ai/llm/moe.html)
