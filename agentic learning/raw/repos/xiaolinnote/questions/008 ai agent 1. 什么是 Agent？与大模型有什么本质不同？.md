...
created: 2026-05-07
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/agent/1_whatisagent.html"
source: "https://xiaolinnote.com/ai/agent/1_whatisagent.html"
last_checked: 2026-05-17
freshness: watch
sha256: 7ced84ca1ba79c6417f041488bf8cb773223e690a48aa6039dfa1c05878f0bb7
related:
...
# 1. 什么是 [[Agent]]？与[[LLM|大模型]]有什么本质不同？

原始链接：https://xiaolinnote.com/ai/agent/1_whatisagent.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 13 分钟约 3884 字

---

# [1. 什么是 Agent？与大模型有什么本质不同？](#_1-什么是-agent-与大模型有什么本质不同)

👔面试官：说说你理解的 AI Agent 是什么？

🙋‍♂️我：Agent 就是给大模型加了插件，比如 ChatGPT 的插件功能，让它能联网搜索、调用 API 啥的。

👔面试官：插件是 Agent？那 ChatGPT 开了搜索功能就是 Agent 了？你说的只是[[Tool Calling|工具调用]]，跟 Agent 差远了。
...
👔面试官：还不够。自主[[Planning|规划]]、多步执行、感知结果再调整，这才是 Agent 的闭环。你给它个目标，它自己把任务拆成多步，一步一步做，每步结果反馈回来再指导下一步，这和普通调工具有本质区别。
...
传统 AI 是你问一个问题它回答一个问题，每次都是独立的，被动响应；而 Agent 有自己的规划能力，你给它一个复杂目标，它会自己把任务拆成多步，通过调工具、访问[[Memory|记忆]]、感知环境来一步步执行，直到完成。
...
### [为什么 Agent 现在才爆发？](#为什么-agent-现在才爆发)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/1_whatisagent.html#main-content)
...
- [1. 什么是 Agent？与大模型有什么本质不同？](https://xiaolinnote.com/ai/agent/1_whatisagent.html#_1-什么是-agent-与大模型有什么本质不同)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/1_whatisagent.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/1_whatisagent.html#📝-详细解析)
- [普通大模型的局限性](https://xiaolinnote.com/ai/agent/1_whatisagent.html#普通大模型的局限性)
- [Agent 特别在哪？](https://xiaolinnote.com/ai/agent/1_whatisagent.html#agent-特别在哪)
- [为什么 Agent 现在才爆发？](https://xiaolinnote.com/ai/agent/1_whatisagent.html#为什么-agent-现在才爆发)
- [Agent 生态的最新趋势](https://xiaolinnote.com/ai/agent/1_whatisagent.html#agent-生态的最新趋势)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/1_whatisagent.html#🎯-面试总结)
- [上一页 Agent 面试题介绍](https://xiaolinnote.com/ai/agent/agent_info.html)
- [下一页 2. Agent 的基本架构由哪些核心组件构成？](https://xiaolinnote.com/ai/agent/2_components.html)
