...
### [先说协作：Agent 之间怎么传递信息](#先说协作-agent-之间怎么传递信息)
...
### [状态管理：多 Agent 共享状态的设计要点](#状态管理-多-agent-共享状态的设计要点)
...
### [再说切换：Orchestrator 怎么决定叫谁](#再说切换-orchestrator-怎么决定叫谁)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/16_collab.html#main-content)
...
- [16. 如何设计多 Agent 的协作与动态切换机制？](https://xiaolinnote.com/ai/agent/16_collab.html#_16-如何设计多-agent-的协作与动态切换机制)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/16_collab.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/16_collab.html#📝-详细解析)
- [先说协作：Agent 之间怎么传递信息](https://xiaolinnote.com/ai/agent/16_collab.html#先说协作-agent-之间怎么传递信息)
- [状态管理：多 Agent 共享状态的设计要点](https://xiaolinnote.com/ai/agent/16_collab.html#状态管理-多-agent-共享状态的设计要点)
- [再说切换：Orchestrator 怎么决定叫谁](https://xiaolinnote.com/ai/agent/16_collab.html#再说切换-orchestrator-怎么决定叫谁)
- [Handoff 模式：Agent 之间的「接力棒」](https://xiaolinnote.com/ai/agent/16_collab.html#handoff-模式-agent-之间的「接力棒」)
- [工程上怎么用](https://xiaolinnote.com/ai/agent/16_collab.html#工程上怎么用)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/16_collab.html#🎯-面试总结)
- [上一页 15. 讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？](https://xiaolinnote.com/ai/agent/15_reflection.html)
