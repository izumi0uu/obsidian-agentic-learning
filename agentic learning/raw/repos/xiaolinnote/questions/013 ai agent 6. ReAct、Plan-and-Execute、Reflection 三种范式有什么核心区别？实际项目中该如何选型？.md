...
### [一、基础款：ReAct 单步迭代范式](#一、基础款-react-单步迭代范式)
...
### [二、复杂任务款：Plan-and-Execute 规划执行范式](#二、复杂任务款-plan-and-execute-规划执行范式)
...
### [三、质量增强款：Reflection 反思迭代范式](#三、质量增强款-reflection-反思迭代范式)
...
### [进阶：动态 Replan 和 Reflexion](#进阶-动态-replan-和-reflexion)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/6_three_patterns.html#main-content)
...
- [6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？](https://xiaolinnote.com/ai/agent/6_three_patterns.html#_6-react、plan-and-execute、reflection-三种范式有什么核心区别-实际项目中该如何选型)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/6_three_patterns.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/6_three_patterns.html#📝-详细解析)
- [一、基础款：ReAct 单步迭代范式](https://xiaolinnote.com/ai/agent/6_three_patterns.html#一、基础款-react-单步迭代范式)
- [二、复杂任务款：Plan-and-Execute 规划执行范式](https://xiaolinnote.com/ai/agent/6_three_patterns.html#二、复杂任务款-plan-and-execute-规划执行范式)
- [三、质量增强款：Reflection 反思迭代范式](https://xiaolinnote.com/ai/agent/6_three_patterns.html#三、质量增强款-reflection-反思迭代范式)
- [进阶：动态 Replan 和 Reflexion](https://xiaolinnote.com/ai/agent/6_three_patterns.html#进阶-动态-replan-和-reflexion)
- [token 消耗对比](https://xiaolinnote.com/ai/agent/6_three_patterns.html#token-消耗对比)
- [选型指南](https://xiaolinnote.com/ai/agent/6_three_patterns.html#选型指南)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/6_three_patterns.html#🎯-面试总结)
- [上一页 5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？](https://xiaolinnote.com/ai/agent/5_react.html)
- [下一页 7. 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？](https://xiaolinnote.com/ai/agent/7_tasksplit.html)
