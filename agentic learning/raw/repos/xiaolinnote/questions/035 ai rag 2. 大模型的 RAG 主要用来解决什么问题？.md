...
created: 2026-05-07
updated: 2026-05-17
url: "https://xiaolinnote.com/ai/rag/2_rag_problems.html"
source: "https://xiaolinnote.com/ai/rag/2_rag_problems.html"
last_checked: 2026-05-17
freshness: watch
sha256: 3e4445d9ba799a188dfe952216ff67c5cd12f85f22cf50daea820c5a76954c2f
related:
...
# 2. [[LLM|大模型]]的 [[RAG]] 主要用来解决什么问题？

原始链接：https://xiaolinnote.com/ai/rag/2_rag_problems.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)RAG大约 9 分钟约 2646 字

---

# [2. 大模型的 RAG 主要用来解决什么问题？](#_2-大模型的-rag-主要用来解决什么问题)
...
### [知识空白：私有数据根本没进过训练集](#知识空白-私有数据根本没进过训练集)
...
### [RAG 是怎么解决这三个问题的](#rag-是怎么解决这三个问题的)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/2_rag_problems.html#main-content)
...
- [2. 大模型的 RAG 主要用来解决什么问题？](https://xiaolinnote.com/ai/rag/2_rag_problems.html#_2-大模型的-rag-主要用来解决什么问题)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/2_rag_problems.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/2_rag_problems.html#📝-详细解析)
- [LLM 的「知识冻结」问题](https://xiaolinnote.com/ai/rag/2_rag_problems.html#llm-的「知识冻结」问题)
- [知识过期：训练数据有截止日期](https://xiaolinnote.com/ai/rag/2_rag_problems.html#知识过期-训练数据有截止日期)
- [知识空白：私有数据根本没进过训练集](https://xiaolinnote.com/ai/rag/2_rag_problems.html#知识空白-私有数据根本没进过训练集)
- [知识缺失的副产品：幻觉](https://xiaolinnote.com/ai/rag/2_rag_problems.html#知识缺失的副产品-幻觉)
- [RAG 是怎么解决这三个问题的](https://xiaolinnote.com/ai/rag/2_rag_problems.html#rag-是怎么解决这三个问题的)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/2_rag_problems.html#🎯-面试总结)
- [上一页 1. 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？](https://xiaolinnote.com/ai/rag/1_whatisrag.html)
- [下一页 3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？](https://xiaolinnote.com/ai/rag/3_rag_vs_finetune.html)
