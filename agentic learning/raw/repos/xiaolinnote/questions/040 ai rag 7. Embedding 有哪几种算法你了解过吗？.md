...
### [为什么 Embedding 算法要一代代演进](#为什么-embedding-算法要一代代演进)
...
### [第一代：静态词向量（Word2Vec / GloVe / FastText）](#第一代-静态词向量-word2vec-glove-fasttext)
...
### [第二代：上下文相关向量（ELMo / BERT）](#第二代-上下文相关向量-elmo-bert)
...
### [第三代：句子级对比学习 Embedding（SBERT / SimCSE / BGE）](#第三代-句子级对比学习-embedding-sbert-simcse-bge)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#main-content)
...
- [7. Embedding 有哪几种算法你了解过吗？](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#_7-embedding-有哪几种算法你了解过吗)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#📝-详细解析)
- [为什么 Embedding 算法要一代代演进](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#为什么-embedding-算法要一代代演进)
- [第一代：静态词向量（Word2Vec / GloVe / FastText）](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#第一代-静态词向量-word2vec-glove-fasttext)
- [第二代：上下文相关向量（ELMo / BERT）](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#第二代-上下文相关向量-elmo-bert)
- [第三代：句子级对比学习 Embedding（SBERT / SimCSE / BGE）](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#第三代-句子级对比学习-embedding-sbert-simcse-bge)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/7_embedding_algos.html#🎯-面试总结)
- [上一页 6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](https://xiaolinnote.com/ai/rag/6_embedding.html)
- [下一页 8. 什么是向量数据库？有没有做过向量数据库的对比选型？](https://xiaolinnote.com/ai/rag/8_vectordb.html)
