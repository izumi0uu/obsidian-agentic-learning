...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/model_selection.html
source: https://xiaolinnote.com/ai/llm/model_selection.html
last_checked: 2026-05-17
freshness: watch
sha256: b2d89379329e159e81d995f9f6d56ee357a5cf3350ae11c6b51ac3e56ea62a9b
related:
...
# 22. 对比使用过哪些主流[[LLM|大模型]]？你们项目中最终选用了哪个模型？为什么？

原始链接：https://xiaolinnote.com/ai/llm/model_selection.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 7 分钟约 2212 字

---

# [22. 对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？](#_22-对比使用过哪些主流大模型-你们项目中最终选用了哪个模型-为什么)
...
### [1. 为什么不能盯着「排行榜」无脑选？](#_1-为什么不能盯着「排行榜」无脑选)
...
### [2. 主流大模型横向盘点（2026 年视角）](#_2-主流大模型横向盘点-2026-年视角)
...
### [3. 我们最终选型落地的思考逻辑](#_3-我们最终选型落地的思考逻辑)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/model_selection.html#main-content)
...
- [22. 对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？](https://xiaolinnote.com/ai/llm/model_selection.html#_22-对比使用过哪些主流大模型-你们项目中最终选用了哪个模型-为什么)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/model_selection.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/model_selection.html#📝-详细解析)
- [1. 为什么不能盯着「排行榜」无脑选？](https://xiaolinnote.com/ai/llm/model_selection.html#_1-为什么不能盯着「排行榜」无脑选)
- [2. 主流大模型横向盘点（2026 年视角）](https://xiaolinnote.com/ai/llm/model_selection.html#_2-主流大模型横向盘点-2026-年视角)
- [3. 我们最终选型落地的思考逻辑](https://xiaolinnote.com/ai/llm/model_selection.html#_3-我们最终选型落地的思考逻辑)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/model_selection.html#🎯-面试总结)
- [上一页 21. 大模型能力评测指标有哪些？](https://xiaolinnote.com/ai/llm/evaluation_metrics.html)
