...
created: 2026-05-17
updated: 2026-05-23
url: https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html
source: https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html
last_checked: 2026-05-17
freshness: watch
sha256: 785e3a3039edd3e392ba977fa24cbd03e497ad68f97e4f6bcf163933bc20f1af
related:
...
原始链接：https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)[[LLM]]大约 15 分钟约 4351 字

---

# [14. KV Cache 是什么？Prompt Caching 的原理是什么？](#_14-kv-cache-是什么-prompt-caching-的原理是什么)
...
### [KV Cache：单次推理内的优化](#kv-cache-单次推理内的优化)
...
### [从 KV Cache 到 Prompt Caching：同一机制的扩展](#从-kv-cache-到-prompt-caching-同一机制的扩展)
...
### [主流 API 的 Prompt Caching 实现](#主流-api-的-prompt-caching-实现)
...
### [适合用 Prompt Caching 的场景](#适合用-prompt-caching-的场景)
...
### [工程陷阱：固定内容在前、动态内容在后](#工程陷阱-固定内容在前、动态内容在后)
...
### [进阶：KV Cache 量化与 PagedAttention](#进阶-kv-cache-量化与-pagedattention)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#main-content)
...
- [14. KV Cache 是什么？Prompt Caching 的原理是什么？](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#_14-kv-cache-是什么-prompt-caching-的原理是什么)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#📝-详细解析)
- [自回归生成里隐藏的低效问题](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#自回归生成里隐藏的低效问题)
- [KV Cache：单次推理内的优化](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#kv-cache-单次推理内的优化)
- [KV Cache 的显存代价](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#kv-cache-的显存代价)
- [从 KV Cache 到 Prompt Caching：同一机制的扩展](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#从-kv-cache-到-prompt-caching-同一机制的扩展)
- [主流 API 的 Prompt Caching 实现](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#主流-api-的-prompt-caching-实现)
- [适合用 Prompt Caching 的场景](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#适合用-prompt-caching-的场景)
- [工程陷阱：固定内容在前、动态内容在后](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#工程陷阱-固定内容在前、动态内容在后)
- [进阶：KV Cache 量化与 PagedAttention](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#进阶-kv-cache-量化与-pagedattention)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html#🎯-面试总结)
- [上一页 13. 大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是什么？](https://xiaolinnote.com/ai/llm/temperature_top_p_top_k.html)
- [下一页 15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？](https://xiaolinnote.com/ai/llm/quantization.html)
