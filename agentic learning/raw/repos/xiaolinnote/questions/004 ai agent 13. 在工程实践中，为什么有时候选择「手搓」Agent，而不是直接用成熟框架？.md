...
你需要定义工具的格式，让 LLM 能正确理解每个工具是什么、需要哪些参数；你需要解析 LLM 返回的[[Tool Calling|工具调用]]结果；你需要在每次调用之间正确维护对话历史，不能丢消息也不能顺序错；你需要处理工具调用失败时的重试逻辑；你可能还需要接入向量数据库做知识检索……这些事情，每一个 Agent 项目都得做一遍，而且大同小异。
...
### [同一个需求，框架写 vs 手搓写，差别在哪？](#同一个需求-框架写-vs-手搓写-差别在哪)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/13_handcode.html#main-content)
...
- [13. 在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？](https://xiaolinnote.com/ai/agent/13_handcode.html#_13-在工程实践中-为什么有时候选择「手搓」agent-而不是直接用成熟框架)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/13_handcode.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/13_handcode.html#📝-详细解析)
- [痛点在什么时候开始出现？](https://xiaolinnote.com/ai/agent/13_handcode.html#痛点在什么时候开始出现)
- [手搓的本质优势：完全掌控](https://xiaolinnote.com/ai/agent/13_handcode.html#手搓的本质优势-完全掌控)
- [同一个需求，框架写 vs 手搓写，差别在哪？](https://xiaolinnote.com/ai/agent/13_handcode.html#同一个需求-框架写-vs-手搓写-差别在哪)
- [什么时候用框架，什么时候手搓？](https://xiaolinnote.com/ai/agent/13_handcode.html#什么时候用框架-什么时候手搓)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/13_handcode.html#🎯-面试总结)
- [上一页 12. Agent 记忆压缩通常有哪些方法？](https://xiaolinnote.com/ai/agent/12_memcompress.html)
- [下一页 14. 如何赋予 LLM 规划能力？](https://xiaolinnote.com/ai/agent/14_planning.html)
