...
created: 2026-05-07
updated: 2026-05-17
url: https://xiaolinnote.com/ai/rag/19_dynamic_update.html
source: https://xiaolinnote.com/ai/rag/19_dynamic_update.html
last_checked: 2026-05-17
freshness: watch
sha256: e16904355e965d136b937af4349315e6f2587059706ae6a8304def1e50af8c17
related:
...
原始链接：https://xiaolinnote.com/ai/rag/19_dynamic_update.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)RAG大约 11 分钟约 3269 字

---

# [19. RAG 知识库如何实现动态与持续更新？](#_19-rag-知识库如何实现动态与持续更新)
...
### [为什么更新 RAG 知识库比更新普通数据库麻烦？](#为什么更新-rag-知识库比更新普通数据库麻烦)

在讲具体方案之前，先搞清楚一个关键问题：为什么 RAG 知识库的更新不能像普通数据库那样直接 UPDATE？原因在于，普通数据库更新一条记录，直接 UPDATE 就行，数据是独立的，改一条不影响别的。但 RAG 知识库的麻烦在于：原始文档和[[Vector Database|向量库]]之间不是一对一的关系，而是一对多的关系。
...
![](https://cdn.xiaolincoding.com//picgo/1776850537192-af6e0006-6cc7-48b5-9cb5-c23fda5f3700.png)
...
![](https://cdn.xiaolincoding.com//picgo/ce5317b029029d03ee11ad9d7d94fb95.png)

### [如何知道文档是否发生了变化？](#如何知道文档是否发生了变化)

搞清楚了更新策略是「先删后增」，下一个绕不开的工程问题就是：系统怎么知道一篇文档「变没变」？

![](https://cdn.xiaolincoding.com//picgo/1776850585738-1505b92d-2257-4d28-b049-3572308ea4f1.png)

最常用的方案是**内容 hash**。每次[[Document Ingestion|文档入库]]时，计算文档内容的 MD5 或 SHA256 摘要，把这个 hash 值和文档 ID、对应的 chunk ID 列表一起存下来（存在 Redis、数据库都行）。下次检测到这篇文档时，重新计算 hash 和存储的值对比：相同说明内容没变，跳过；不同说明内容有更新，触发重处理流程。
...
### [文档 ID 和 chunk ID 的设计](#文档-id-和-chunk-id-的设计)
...
### [两种主流的变更感知方式](#两种主流的变更感知方式)

前面说了怎么检测变更（hash）和怎么处理变更（先删后增），那系统怎么在第一时间感知到文档需要更新？有两种主流方案，各有适用场景。

![](https://cdn.xiaolincoding.com//picgo/1776850625161-7f6c92be-b7d4-4ccc-a60a-4100ef447d0d.png)
...
![](https://cdn.xiaolincoding.com//picgo/1776850658577-890c41d5-cda3-4c36-acef-850b62366f7a.png)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#main-content)
...
- [19. RAG 知识库如何实现动态与持续更新？](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#_19-rag-知识库如何实现动态与持续更新)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#📝-详细解析)
- [为什么更新 RAG 知识库比更新普通数据库麻烦？](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#为什么更新-rag-知识库比更新普通数据库麻烦)
- [如何知道文档是否发生了变化？](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#如何知道文档是否发生了变化)
- [文档 ID 和 chunk ID 的设计](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#文档-id-和-chunk-id-的设计)
- [两种主流的变更感知方式](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#两种主流的变更感知方式)
- [全量重建是最后的手段](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#全量重建是最后的手段)
- [灰度更新：稳妥地切换新版本](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#灰度更新-稳妥地切换新版本)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/19_dynamic_update.html#🎯-面试总结)
- [上一页 18. 怎么量化你的 RAG 效果？](https://xiaolinnote.com/ai/rag/18_evaluation.html)
- [下一页 20. 在实际落地中，你觉得 RAG 最难的地方是哪里？](https://xiaolinnote.com/ai/rag/20_hardest_parts.html)
