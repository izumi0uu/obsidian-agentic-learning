...
freshness: watch
sha256: d3d8c79f367552542ddcc4a89fa2151e862e45637dea8c899eb00ed9b64773de
related:
...
原始链接：https://xiaolinnote.com/ai/llm/what_is_llm.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)[[LLM]]大约 18 分钟约 5342 字

---

# [1. 什么是大语言模型？和传统 NLP 模型有什么区别？](#_1-什么是大语言模型-和传统-nlp-模型有什么区别)
...
### [BERT 时代：预训练通了一半](#bert-时代-预训练通了一半)
...
### [LLM 的本质：把所有任务收编成「预测下一个 token」](#llm-的本质-把所有任务收编成「预测下一个-token」)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/what_is_llm.html#main-content)
...
- [1. 什么是大语言模型？和传统 NLP 模型有什么区别？](https://xiaolinnote.com/ai/llm/what_is_llm.html#_1-什么是大语言模型-和传统-nlp-模型有什么区别)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/what_is_llm.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/what_is_llm.html#📝-详细解析)
- [传统 NLP 是怎么干活的？](https://xiaolinnote.com/ai/llm/what_is_llm.html#传统-nlp-是怎么干活的)
- [BERT 时代：预训练通了一半](https://xiaolinnote.com/ai/llm/what_is_llm.html#bert-时代-预训练通了一半)
- [LLM 的本质：把所有任务收编成「预测下一个 token」](https://xiaolinnote.com/ai/llm/what_is_llm.html#llm-的本质-把所有任务收编成「预测下一个-token」)
- [「涌现能力」：量变到质变的关键](https://xiaolinnote.com/ai/llm/what_is_llm.html#「涌现能力」-量变到质变的关键)
- [三个本质区别总结](https://xiaolinnote.com/ai/llm/what_is_llm.html#三个本质区别总结)
- [这场转变对工程团队意味着什么](https://xiaolinnote.com/ai/llm/what_is_llm.html#这场转变对工程团队意味着什么)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/what_is_llm.html#🎯-面试总结)
- [上一页 大模型工程面试题介绍](https://xiaolinnote.com/ai/llm/llm_info.html)
- [下一页 2. 讲讲 Transformer 架构基本原理？Encoder 和 Decoder 是什么？](https://xiaolinnote.com/ai/llm/transformer_architecture.html)
