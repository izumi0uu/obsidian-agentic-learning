...
freshness: watch
sha256: d8eae8458f2fdaed4e120fe8bc80463a060804359db296d256263be6b92f20fd
related:
...
原始链接：https://xiaolinnote.com/ai/agent/14_planning.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 11 分钟约 3359 字

---


👔面试官：说说你是怎么给 LLM 加[[Planning|规划能力]]的？
...
### [CoT：最简单的激活方式，加一句话就够了](#cot-最简单的激活方式-加一句话就够了)
...
### [ToT：从「一条链」到「一棵树」，解决走错方向的问题](#tot-从「一条链」到「一棵树」-解决走错方向的问题)
...
### [GoT：从「树」到「图」，解决推理结果不能复用的问题](#got-从「树」到「图」-解决推理结果不能复用的问题)
...
### [工程里真正常用的规划模式：Plan-and-Execute](#工程里真正常用的规划模式-plan-and-execute)

CoT、ToT、GoT 说的都是「怎么让 LLM 把推理过程做得更好」，但在真实的 Agent 项目里，还有一种更贴近工程实践的规划模式，叫做 [[Plan-and-Solve Prompting|Plan-and-Execute]]（先规划再执行）。
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/14_planning.html#main-content)
...
- [14. 如何赋予 LLM 规划能力？](https://xiaolinnote.com/ai/agent/14_planning.html#_14-如何赋予-llm-规划能力)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/14_planning.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/14_planning.html#📝-详细解析)
- [CoT：最简单的激活方式，加一句话就够了](https://xiaolinnote.com/ai/agent/14_planning.html#cot-最简单的激活方式-加一句话就够了)
- [ToT：从「一条链」到「一棵树」，解决走错方向的问题](https://xiaolinnote.com/ai/agent/14_planning.html#tot-从「一条链」到「一棵树」-解决走错方向的问题)
- [GoT：从「树」到「图」，解决推理结果不能复用的问题](https://xiaolinnote.com/ai/agent/14_planning.html#got-从「树」到「图」-解决推理结果不能复用的问题)
- [三者的演进关系](https://xiaolinnote.com/ai/agent/14_planning.html#三者的演进关系)
- [工程里真正常用的规划模式：Plan-and-Execute](https://xiaolinnote.com/ai/agent/14_planning.html#工程里真正常用的规划模式-plan-and-execute)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/14_planning.html#🎯-面试总结)
- [上一页 13. 在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？](https://xiaolinnote.com/ai/agent/13_handcode.html)
- [下一页 15. 讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？](https://xiaolinnote.com/ai/agent/15_reflection.html)
