...
**静态拆分**是你提前把任务流程设计好，固定成一个确定的 [[Agent Workflow|Workflow]]，每一步是什么、按什么顺序执行，全部事先写死。比如「写一篇技术博客」，固定拆成：搜索资料 -> 整理大纲 -> 逐段撰写 -> 润色校对，四步顺序执行。好处是行为完全可预测，出了问题知道是哪一步的问题，好排查；坏处是灵活性低，遇到你没设计进流程的情况就容易卡住。
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/7_tasksplit.html#main-content)
...
- [7. 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？](https://xiaolinnote.com/ai/agent/7_tasksplit.html#_7-复杂任务怎么做的任务拆分-为什么要拆分-效果如何提升)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/7_tasksplit.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/7_tasksplit.html#📝-详细解析)
- [为什么任务要拆分？](https://xiaolinnote.com/ai/agent/7_tasksplit.html#为什么任务要拆分)
- [任务拆分两种思路](https://xiaolinnote.com/ai/agent/7_tasksplit.html#任务拆分两种思路)
- [自适应拆分：做不好就继续拆](https://xiaolinnote.com/ai/agent/7_tasksplit.html#自适应拆分-做不好就继续拆)
- [执行中的 Replan 机制](https://xiaolinnote.com/ai/agent/7_tasksplit.html#执行中的-replan-机制)
- [拆分结果的验证标准](https://xiaolinnote.com/ai/agent/7_tasksplit.html#拆分结果的验证标准)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/7_tasksplit.html#🎯-面试总结)
- [上一页 6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？](https://xiaolinnote.com/ai/agent/6_three_patterns.html)
- [下一页 8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？](https://xiaolinnote.com/ai/agent/8_memory.html)
