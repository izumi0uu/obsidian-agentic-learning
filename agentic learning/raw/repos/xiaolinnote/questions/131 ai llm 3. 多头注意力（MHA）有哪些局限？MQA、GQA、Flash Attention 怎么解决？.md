...
原始链接：https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)[[LLM]]大约 15 分钟约 4440 字

---

# [3. 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？](#_3-多头注意力-mha-有哪些局限-mqa、gqa、flash-attention-怎么解决)
...
### [先理清 MHA 的瓶颈到底卡在哪](#先理清-mha-的瓶颈到底卡在哪)
...
### [MQA：暴力共享 K/V，显存直接压到 1/H](#mqa-暴力共享-k-v-显存直接压到-1-h)
...
### [GQA：折中方案，效果与显存的甜蜜点](#gqa-折中方案-效果与显存的甜蜜点)
...
### [Flash Attention：换条赛道，从计算实现优化](#flash-attention-换条赛道-从计算实现优化)
...
### [三类优化的关系：是叠加不是替代](#三类优化的关系-是叠加不是替代)
...
### [拓展：长上下文时代还有哪些新方向](#拓展-长上下文时代还有哪些新方向)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#main-content)
...
- [3. 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#_3-多头注意力-mha-有哪些局限-mqa、gqa、flash-attention-怎么解决)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#📝-详细解析)
- [先理清 MHA 的瓶颈到底卡在哪](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#先理清-mha-的瓶颈到底卡在哪)
- [MQA：暴力共享 K/V，显存直接压到 1/H](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#mqa-暴力共享-k-v-显存直接压到-1-h)
- [GQA：折中方案，效果与显存的甜蜜点](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#gqa-折中方案-效果与显存的甜蜜点)
- [Flash Attention：换条赛道，从计算实现优化](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#flash-attention-换条赛道-从计算实现优化)
- [三类优化的关系：是叠加不是替代](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#三类优化的关系-是叠加不是替代)
- [拓展：长上下文时代还有哪些新方向](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#拓展-长上下文时代还有哪些新方向)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html#🎯-面试总结)
- [上一页 2. 讲讲 Transformer 架构基本原理？Encoder 和 Decoder 是什么？](https://xiaolinnote.com/ai/llm/transformer_architecture.html)
- [下一页 4. 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？](https://xiaolinnote.com/ai/llm/position_encoding.html)
