...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/quantization.html
source: https://xiaolinnote.com/ai/llm/quantization.html
last_checked: 2026-05-17
freshness: watch
sha256: 6f3be0d1abac6cf84989a3dc45dd717655b7abfcf2fa47e38d65f37808f53fd0
related:
...
# 15. [[LLM|大模型]]量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？

原始链接：https://xiaolinnote.com/ai/llm/quantization.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 16 分钟约 4927 字

---

# [15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？](#_15-大模型量化是什么-int8-int4-awq-gptq-怎么选)
...
### [量化是什么？为什么大模型必须量化](#量化是什么-为什么大模型必须量化)
...
### [INT8 / INT4 各自的精度边界](#int8-int4-各自的精度边界)
...
### [GPTQ：基于误差补偿的逐层量化](#gptq-基于误差补偿的逐层量化)
...
### [QLoRA 与 NF4：让消费级 GPU 微调成为可能](#qlora-与-nf4-让消费级-gpu-微调成为可能)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/quantization.html#main-content)
...
- [15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？](https://xiaolinnote.com/ai/llm/quantization.html#_15-大模型量化是什么-int8-int4-awq-gptq-怎么选)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/quantization.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/quantization.html#📝-详细解析)
- [量化是什么？为什么大模型必须量化](https://xiaolinnote.com/ai/llm/quantization.html#量化是什么-为什么大模型必须量化)
- [量化的核心：映射连续到离散](https://xiaolinnote.com/ai/llm/quantization.html#量化的核心-映射连续到离散)
- [INT8 / INT4 各自的精度边界](https://xiaolinnote.com/ai/llm/quantization.html#int8-int4-各自的精度边界)
- [GPTQ：基于误差补偿的逐层量化](https://xiaolinnote.com/ai/llm/quantization.html#gptq-基于误差补偿的逐层量化)
- [AWQ：激活感知的权重保护](https://xiaolinnote.com/ai/llm/quantization.html#awq-激活感知的权重保护)
- [QLoRA 与 NF4：让消费级 GPU 微调成为可能](https://xiaolinnote.com/ai/llm/quantization.html#qlora-与-nf4-让消费级-gpu-微调成为可能)
- [怎么选量化方案](https://xiaolinnote.com/ai/llm/quantization.html#怎么选量化方案)
- [量化的副作用与陷阱](https://xiaolinnote.com/ai/llm/quantization.html#量化的副作用与陷阱)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/quantization.html#🎯-面试总结)
- [上一页 14. KV Cache 是什么？Prompt Caching 的原理是什么？](https://xiaolinnote.com/ai/llm/kv_cache_prompt_caching.html)
- [下一页 16. 如何写好 Prompt？分享下 Prompt 工程实践经验？](https://xiaolinnote.com/ai/llm/prompt_engineering.html)
