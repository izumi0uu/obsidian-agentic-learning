...
created: 2026-05-17
updated: 2026-05-17
url: https://xiaolinnote.com/ai/llm/deployment_frameworks.html
source: https://xiaolinnote.com/ai/llm/deployment_frameworks.html
last_checked: 2026-05-17
freshness: watch
sha256: cde2e73c243ffba028cf8e677764a3ae236a6a38901f38d6e68a9628d19a27ea
related:
...
# 20. [[LLM|大模型]]部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？

原始链接：https://xiaolinnote.com/ai/llm/deployment_frameworks.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 15 分钟约 4430 字

---

# [20. 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？](#_20-大模型部署有哪些主流方案-vllm、tgi、llama-cpp、sglang-实际项目里怎么选)
...
### [vLLM 与 PagedAttention：操作系统虚拟内存的灵感](#vllm-与-pagedattention-操作系统虚拟内存的灵感)
...
### [SGLang 与 RadixAttention：共享前缀的杀手锏](#sglang-与-radixattention-共享前缀的杀手锏)
...
### [TGI：HuggingFace 生态集成方案](#tgi-huggingface-生态集成方案)
...
### [llama.cpp：CPU / 边缘设备的事实标准](#llama-cpp-cpu-边缘设备的事实标准)
...
### [TensorRT-LLM：NVIDIA 官方极致优化](#tensorrt-llm-nvidia-官方极致优化)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#main-content)
...
- [20. 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#_20-大模型部署有哪些主流方案-vllm、tgi、llama-cpp、sglang-实际项目里怎么选)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#📝-详细解析)
- [部署框架解决的核心问题](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#部署框架解决的核心问题)
- [vLLM 与 PagedAttention：操作系统虚拟内存的灵感](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#vllm-与-pagedattention-操作系统虚拟内存的灵感)
- [SGLang 与 RadixAttention：共享前缀的杀手锏](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#sglang-与-radixattention-共享前缀的杀手锏)
- [TGI：HuggingFace 生态集成方案](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#tgi-huggingface-生态集成方案)
- [llama.cpp：CPU / 边缘设备的事实标准](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#llama-cpp-cpu-边缘设备的事实标准)
- [TensorRT-LLM：NVIDIA 官方极致优化](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#tensorrt-llm-nvidia-官方极致优化)
- [怎么选部署方案：决策矩阵](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#怎么选部署方案-决策矩阵)
- [部署的三大隐藏陷阱](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#部署的三大隐藏陷阱)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/deployment_frameworks.html#🎯-面试总结)
- [上一页 19. MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？](https://xiaolinnote.com/ai/llm/moe.html)
- [下一页 21. 大模型能力评测指标有哪些？](https://xiaolinnote.com/ai/llm/evaluation_metrics.html)
