...
原始链接：https://xiaolinnote.com/ai/llm/position_encoding.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LLM大约 16 分钟约 4809 字

---

# [4. 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？](#_4-大模型的位置编码是干什么用的-sin-cos、rope、alibi-有什么区别)
...
### [为什么 Attention 必须有位置编码](#为什么-attention-必须有位置编码)
...
### [sin/cos 绝对位置编码：原始 Transformer 的方案](#sin-cos-绝对位置编码-原始-transformer-的方案)
...
### [绝对位置 vs 相对位置：模型真正想要什么](#绝对位置-vs-相对位置-模型真正想要什么)
...
### [RoPE：用旋转把相对位置编进点积](#rope-用旋转把相对位置编进点积)
...
### [ALiBi：直接给注意力加距离惩罚](#alibi-直接给注意力加距离惩罚)
...
### [三种方案对比：为什么 RoPE 赢了](#三种方案对比-为什么-rope-赢了)
...
### [拓展：长上下文外推（NTK / YaRN 简介）](#拓展-长上下文外推-ntk-yarn-简介)
...
- [跳至主要內容](https://xiaolinnote.com/ai/llm/position_encoding.html#main-content)
...
- [4. 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？](https://xiaolinnote.com/ai/llm/position_encoding.html#_4-大模型的位置编码是干什么用的-sin-cos、rope、alibi-有什么区别)
- [💡 简要回答](https://xiaolinnote.com/ai/llm/position_encoding.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/llm/position_encoding.html#📝-详细解析)
- [为什么 Attention 必须有位置编码](https://xiaolinnote.com/ai/llm/position_encoding.html#为什么-attention-必须有位置编码)
- [sin/cos 绝对位置编码：原始 Transformer 的方案](https://xiaolinnote.com/ai/llm/position_encoding.html#sin-cos-绝对位置编码-原始-transformer-的方案)
- [绝对位置 vs 相对位置：模型真正想要什么](https://xiaolinnote.com/ai/llm/position_encoding.html#绝对位置-vs-相对位置-模型真正想要什么)
- [RoPE：用旋转把相对位置编进点积](https://xiaolinnote.com/ai/llm/position_encoding.html#rope-用旋转把相对位置编进点积)
- [ALiBi：直接给注意力加距离惩罚](https://xiaolinnote.com/ai/llm/position_encoding.html#alibi-直接给注意力加距离惩罚)
- [三种方案对比：为什么 RoPE 赢了](https://xiaolinnote.com/ai/llm/position_encoding.html#三种方案对比-为什么-rope-赢了)
- [拓展：长上下文外推（NTK / YaRN 简介）](https://xiaolinnote.com/ai/llm/position_encoding.html#拓展-长上下文外推-ntk-yarn-简介)
- [🎯 面试总结](https://xiaolinnote.com/ai/llm/position_encoding.html#🎯-面试总结)
- [上一页 3. 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？](https://xiaolinnote.com/ai/llm/mha_mqa_gqa_flash_attention.html)
- [下一页 5. 什么是大模型项目的分词器？原理是什么？](https://xiaolinnote.com/ai/llm/tokenizer.html)
