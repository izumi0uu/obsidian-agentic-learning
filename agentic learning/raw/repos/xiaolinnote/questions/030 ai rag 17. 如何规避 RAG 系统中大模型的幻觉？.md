...
created: 2026-05-07
updated: 2026-05-09
url: "https://xiaolinnote.com/ai/rag/17_hallucination.html"
source: "https://xiaolinnote.com/ai/rag/17_hallucination.html"
last_checked: 2026-05-07
freshness: watch
sha256: 845663340ec5e3ab9004d3b1079c7c0113c864a617d993f6900c9c3ef2190c74
related:
...
原始链接：https://xiaolinnote.com/ai/rag/17_hallucination.html
...
[公众号@小林面试笔记](https://xiaolinnote.com)大约 11 分钟约 3422 字
...
我遇到过的 RAG 幻觉主要有两类。第一类是检索没有召回到相关内容，LLM 没有可用的上下文，靠自身知识在编造答案。第二类是检索内容召回了但 LLM 没有严格遵循，在文档内容的基础上加了自己的推断。我用来规避幻觉的策略主要有四个方向：第一是 Prompt 强约束，明确告知 LLM 只能根据提供的资料回答，资料里没有的就说不知道；第二是[[RAG Evaluation|检索质量]]门控，Rerank 分数低于阈值就直接拒答，不让 LLM 在低质量上下文上硬撑；第三是生成后引用核查，每个关键的声明都要在 chunk 里找到来源依据；第四是结构化输出强制溯源，让 LLM 输出 JSON，每条结论必须附上来源编号。其中 Prompt 强约束加检索质量门控是我觉得成本最低、收效最快的组合，生产系统上线前这两个必须做。

## [📝 详细解析](#📝-详细解析)

### [幻觉是什么，为什么 RAG 里会有幻觉？](#幻觉是什么-为什么-rag-里会有幻觉)
...
![](https://cdn.xiaolincoding.com//picgo/1776838277255-71cf642e-a274-4095-b22b-35bd88bb8a57.png)
...
### [方案一：用 Prompt 告诉 LLM「只准照着资料说」](#方案一-用-prompt-告诉-llm「只准照着资料说」)
...
### [方案二：检索质量差时，直接拒绝回答](#方案二-检索质量差时-直接拒绝回答)
...
### [方案三：答案生成后，逐条核查有没有「凭空捏造」](#方案三-答案生成后-逐条核查有没有「凭空捏造」)
...
### [方案四：强制 LLM 输出时带上来源编号](#方案四-强制-llm-输出时带上来源编号)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/17_hallucination.html#main-content)
...
- [17. 如何规避 RAG 系统中大模型的幻觉？](https://xiaolinnote.com/ai/rag/17_hallucination.html#_17-如何规避-rag-系统中大模型的幻觉)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/17_hallucination.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/17_hallucination.html#📝-详细解析)
- [幻觉是什么，为什么 RAG 里会有幻觉？](https://xiaolinnote.com/ai/rag/17_hallucination.html#幻觉是什么-为什么-rag-里会有幻觉)
- [方案一：用 Prompt 告诉 LLM「只准照着资料说」](https://xiaolinnote.com/ai/rag/17_hallucination.html#方案一-用-prompt-告诉-llm「只准照着资料说」)
- [方案二：检索质量差时，直接拒绝回答](https://xiaolinnote.com/ai/rag/17_hallucination.html#方案二-检索质量差时-直接拒绝回答)
- [方案三：答案生成后，逐条核查有没有「凭空捏造」](https://xiaolinnote.com/ai/rag/17_hallucination.html#方案三-答案生成后-逐条核查有没有「凭空捏造」)
- [方案四：强制 LLM 输出时带上来源编号](https://xiaolinnote.com/ai/rag/17_hallucination.html#方案四-强制-llm-输出时带上来源编号)
- [四个方案怎么组合？](https://xiaolinnote.com/ai/rag/17_hallucination.html#四个方案怎么组合)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/17_hallucination.html#🎯-面试总结)
- [上一页 16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？](https://xiaolinnote.com/ai/rag/16_graph_db.html)
- [下一页 18. 怎么量化你的 RAG 效果？](https://xiaolinnote.com/ai/rag/18_evaluation.html)
