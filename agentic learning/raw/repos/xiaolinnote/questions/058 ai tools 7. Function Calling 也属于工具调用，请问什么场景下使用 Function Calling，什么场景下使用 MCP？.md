...
原创[公众号@小林面试笔记](https://xiaolinnote.com)Tools大约 8 分钟约 2534 字

---

# [7. Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？](#_7-function-calling-也属于工具调用-请问什么场景下使用-function-calling-什么场景下使用-mcp)
