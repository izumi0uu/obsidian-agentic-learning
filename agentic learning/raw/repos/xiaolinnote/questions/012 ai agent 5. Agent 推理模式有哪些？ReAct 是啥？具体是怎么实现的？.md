...
freshness: watch
sha256: 97ed266bb8e7fea49fbe001e9b436725ba467d015ac0c8459ff47237fd16315a
related:
...
原始链接：https://xiaolinnote.com/ai/agent/5_react.html
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)agent大约 19 分钟约 5615 字
...
👔面试官：对了，这才是关键。模型每次只做一件事：根据历史输出下一步的 Thought 和 Action。你的代码负责检测输出、执行工具、把 [[Agent Loop|Observation]] 填回历史，再次调用模型，这才叫 ReAct 的真正实现方式。
...
最基础的是直接输出答案，没有中间推理；CoT 是让 LLM 先把推理过程写出来再给答案，准确率更高；ReAct 是在 CoT 基础上加了「行动」，让 LLM 交替输出思考和[[Tool Calling|工具调用]]，每次行动后再根据结果继续思考，形成一个循环。
...
**CoT**，全称 Chain of Thought（[[Reasoning Trace|思维链]]），由 Wei 等人在 2022 年提出，是最早也最简单的解法。
...
### [Plan-and-Execute：先规划再执行](#plan-and-execute-先规划再执行)
...
- [跳至主要內容](https://xiaolinnote.com/ai/agent/5_react.html#main-content)
...
- [5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？](https://xiaolinnote.com/ai/agent/5_react.html#_5-agent-推理模式有哪些-react-是啥-具体是怎么实现的)
- [💡 简要回答](https://xiaolinnote.com/ai/agent/5_react.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/agent/5_react.html#📝-详细解析)
- [什么是推理模式？](https://xiaolinnote.com/ai/agent/5_react.html#什么是推理模式)
- [CoT是什么？](https://xiaolinnote.com/ai/agent/5_react.html#cot是什么)
- [ReAct 是什么？](https://xiaolinnote.com/ai/agent/5_react.html#react-是什么)
- [Plan-and-Execute：先规划再执行](https://xiaolinnote.com/ai/agent/5_react.html#plan-and-execute-先规划再执行)
- [🎯 面试总结](https://xiaolinnote.com/ai/agent/5_react.html#🎯-面试总结)
- [上一页 4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？](https://xiaolinnote.com/ai/agent/4_patterns.html)
- [下一页 6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？](https://xiaolinnote.com/ai/agent/6_three_patterns.html)
