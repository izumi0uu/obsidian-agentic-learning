...
freshness: watch
sha256: 46cecc10ff8e05261503343a607449b3ce7267216d54f6fdbcfd8884967ed669
related:
...
# [5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？](#_5-agent-推理模式有哪些-react-是啥-具体是怎么实现的)

👔面试官：你做过 Agent 项目，那你说说 ReAct 是什么，跟普通的 LLM 调用有什么区别？

🙋‍♂️我：ReAct 就是让模型一边思考一边行动，[[Tool Calling|调工具]]拿结果，然后继续思考……就是一个循环。
