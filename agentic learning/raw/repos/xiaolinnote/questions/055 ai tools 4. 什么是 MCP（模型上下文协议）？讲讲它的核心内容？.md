...
freshness: watch
sha256: ad1480c24fdcf8be08774559674cb2e8973aaf53a3bd82818b2d4fd8f9dabcb4
related:
...
[公众号@小林面试笔记](https://xiaolinnote.com)大约 10 分钟约 3067 字
...
MCP（[[MCP|Model Context Protocol]]，模型上下文协议）的设计思路，可以用 USB 接口来类比。在 USB 标准出现之前，鼠标用这个接口、键盘用那个接口、打印机又是另一个，换台电脑就要愁接口不兼容。USB 出现之后，所有外设统一接口，任何设备插到任何电脑都能工作，设备厂商只需要做一次适配，全球所有 USB 电脑都能用。
