...
freshness: watch
sha256: 41b0ced01eef80bcfd3e7a989b2046cee72d05acdbde2df00dfdb28f3459d13c
related:
...
原始链接：https://xiaolinnote.com/ai/rag/8_vectordb.html
...
[公众号@小林面试笔记](https://xiaolinnote.com)大约 11 分钟约 3427 字
...
🙋‍♂️我：向量数据库我知道，就是在 MySQL 里加个向量字段，然后用 LIKE 语句做模糊匹配[[Retriever|检索]]，差不多就是存向量的数据库吧。

👔面试官：MySQL 加个向量字段？那是存向量，不是向量数据库。你用 LIKE 做语义检索？LIKE 是字符串模糊匹配，跟向量相似度搜索完全是两码事。你对向量数据库的理解就停留在「存了个向量字段」？

🙋‍♂️我：那应该是用 Elasticsearch 吧？ES 不是也能做向量检索吗，加个 dense\_vector 字段类型就行了，没必要专门引入一个新的数据库吧。
...
我自己做过一些选型，本地开发阶段我用 Chroma，零配置上手极快；生产环境的中小规模我推荐 Qdrant，性能不错、API 也比较简洁；如果到了超大规模就要考虑 [[Vector Database|Milvus]] 了，字节和小米都在用；不想自己运维的话 Pinecone 是一个云托管的选项；如果项目里已经有 PostgreSQL，也可以直接用 pgvector 插件，不用引入新组件。
...
### [核心索引算法：HNSW 和 IVF](#核心索引算法-hnsw-和-ivf)
...
- [跳至主要內容](https://xiaolinnote.com/ai/rag/8_vectordb.html#main-content)
...
- [8. 什么是向量数据库？有没有做过向量数据库的对比选型？](https://xiaolinnote.com/ai/rag/8_vectordb.html#_8-什么是向量数据库-有没有做过向量数据库的对比选型)
- [💡 简要回答](https://xiaolinnote.com/ai/rag/8_vectordb.html#💡-简要回答)
- [📝 详细解析](https://xiaolinnote.com/ai/rag/8_vectordb.html#📝-详细解析)
- [什么是向量数据库？](https://xiaolinnote.com/ai/rag/8_vectordb.html#什么是向量数据库)
- [为什么需要专门的向量数据库？](https://xiaolinnote.com/ai/rag/8_vectordb.html#为什么需要专门的向量数据库)
- [核心索引算法：HNSW 和 IVF](https://xiaolinnote.com/ai/rag/8_vectordb.html#核心索引算法-hnsw-和-ivf)
- [向量数据库的核心能力](https://xiaolinnote.com/ai/rag/8_vectordb.html#向量数据库的核心能力)
- [选型建议](https://xiaolinnote.com/ai/rag/8_vectordb.html#选型建议)
- [🎯 面试总结](https://xiaolinnote.com/ai/rag/8_vectordb.html#🎯-面试总结)
- [上一页 7. Embedding 有哪几种算法你了解过吗？](https://xiaolinnote.com/ai/rag/7_embedding_algos.html)
- [下一页 9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？](https://xiaolinnote.com/ai/rag/9_vectordb_practice.html)
