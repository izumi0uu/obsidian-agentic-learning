...
freshness: watch
sha256: d241dd2df1b179ac93195c50914406071477e5c4a5c9a5e756cbdf6f90e579be
related:
...
原创[公众号@小林面试笔记](https://xiaolinnote.com)RAG大约 11 分钟约 3167 字

---

# [9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？](#_9-讲讲你用的向量数据库-数据量级是多大-性能如何-遇到过性能瓶颈吗)

👔面试官：你在项目里用的什么向量数据库？数据量级大概多少？

🙋‍♂️我：用的 Chroma，挺好用的，pip install 一下就能跑了。

👔面试官：Chroma？本地[[Embedding|嵌入]]式数据库你拿来做生产？你数据量多大知道吗？
