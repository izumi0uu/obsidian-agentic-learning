...
freshness: watch
sha256: 0cce497f97b99bc7b6f7aba61dd2db24be2a7a7e11b0589620721541b0210945
...
父级题组：你用过哪些 Agent 框架？选型是如何选的？你最终场景的评价指标是什么？
...
出现位置：你用过哪些 [[Agent Framework|Agent 框架]]？选型是如何选的？你最终场景的评价指标是什么？
