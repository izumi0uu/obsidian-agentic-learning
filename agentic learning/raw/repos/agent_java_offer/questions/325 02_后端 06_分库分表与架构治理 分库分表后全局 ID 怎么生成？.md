...
freshness: watch
sha256: f42f6268135f8b7b841e5eac6d51e86f9c39f269018dafff7ebe7cdd44a176de
...
答：常见方案是雪花算法、号段模式、数据库序列服务。雪花适合高并发且去中心化，号段适合稳定批量发号。要重点处理时钟回拨、重复ID、趋势递增和[[Observability|可观测性]]，避免主键冲突事故。
