...
freshness: watch
sha256: 161b3f3361fe480fba7f31a3940d28065a587c72e7326563775335cd6325d90f
...
# **主动提问与检索：** 在暂停处，[[LLM]]会插入一个特殊的占位符（如 `[SEARCH]`），并主动提出一个需要查询的问题（例如，“法国的首都是哪里？”）。
...
追问题目：3. **主动提问与检索：** 在暂停处，LLM会插入一个特殊的占位符（如 `[SEARCH]`），并主动提出一个需要查询的问题（例如，“法国的首都是哪里？”）。
