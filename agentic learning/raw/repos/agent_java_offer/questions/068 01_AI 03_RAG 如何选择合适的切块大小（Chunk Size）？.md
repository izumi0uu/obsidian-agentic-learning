...
freshness: watch
sha256: 5a0a6598f441f3efcc606186d9ecf99836158d1cb10419c6968c0231a5da47e1
...
父级题组：在构建知识库时，文本切块策略至关重要。你会如何选择合适的切块大小和重叠长度？这背后有什么权衡？
...
追问题目：**如何选择合适的切块大小（Chunk Size）？**

出现位置：在构建知识库时，文本切块策略至关重要。你会如何选择合适的切块大小和重叠长度？这背后有什么权衡？
