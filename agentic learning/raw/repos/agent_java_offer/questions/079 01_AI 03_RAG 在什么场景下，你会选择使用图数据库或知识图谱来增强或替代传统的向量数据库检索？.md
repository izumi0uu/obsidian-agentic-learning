...
答：
当问题依赖实体关系和多跳推理时，图谱明显优于纯[[Retriever|向量检索]]，比如“金融领域的公司股权结构; 医疗领域的药物-基因-疾病关系网络; 供应链管理”。图结构还能给出可解释证据链，适合合规审计和风控。多数业务不是替代关系，而是互补：先图谱定位实体与关系，再构建更精确的查询, 去向量查询补充非结构化上下文，最后交给模型综合生成。
