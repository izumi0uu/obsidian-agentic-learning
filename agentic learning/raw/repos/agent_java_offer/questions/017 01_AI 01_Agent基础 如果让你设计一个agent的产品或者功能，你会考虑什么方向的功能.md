...
freshness: watch
sha256: da6aa3e938065d1dc035467ee72470e3afc815a105891b50d098001d9fbc96d8
...
# 如果让你设计一个agent的产品或者功能，你会考虑什么方向的功能
...
**口述答案（约300字）**：
我会优先选“高频、可量化、可回滚”的业务场景，比如企业知识问答+任务执行助手。设计思路是先确定目标指标，再反推功能。第一步定义北极星指标，如任务完成率、[[Human-in-the-loop|人工介入]]率、平均处理时长、单位任务成本。第二步做能力拆分：意图识别、[[RAG|检索增强]]、工具执行、结果审校、异常兜底。第三步做安全和治理：[[Least Privilege Tools|最小权限]]、敏感操作二次确认、全链路审计。第四步做上线策略：小流量灰度、在线AB、失败快速回滚。我的经验是先做“半自动”而不是“全自动”，把高风险动作放[[Approval Gate|人工审批]]，先把稳定性和信任建立起来，再逐步放开自治程度。这样产品落地速度更快，业务方也更愿意采用。
**来源**：公开社区资料
