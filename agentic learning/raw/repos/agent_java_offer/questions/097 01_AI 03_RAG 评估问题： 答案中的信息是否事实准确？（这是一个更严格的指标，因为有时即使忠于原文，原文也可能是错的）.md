...
freshness: watch
sha256: 61cd6a60ae5eb31ee256e7d43bbaba67fc31aaf6554790e7c3c8ad82e5b4f652
...
# **[[Evaluation|评估]]问题：** 答案中的信息是否事实准确？（这是一个更严格的指标，因为有时即使忠于原文，原文也可能是错的）
...
父级题组：如何全面地评估一个 RAG 系统的性能？请分别从检索和生成两个阶段提出评估指标。
...
出现位置：如何全面地评估一个 RAG 系统的性能？请分别从检索和生成两个阶段提出评估指标。
