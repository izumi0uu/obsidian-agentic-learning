...
freshness: watch
sha256: c1d10d87042701fc1f83a0e8d5ca1bcd1af53a1a1cc9093a74488bc8d3685bde
...
击穿是热点 key 失效瞬间并发打到 DB, 治理核心是把“多线程重建”收敛成“单线程重建”，其余线程要么等、要么快速返回. 常用方案是互斥重建（分布式锁）:只有一个线程去查库并回填缓存，其他线程等待或快速[[Durable Execution|失败重试]]、热点永不过期配合主动更新
