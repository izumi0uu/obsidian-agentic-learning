...
freshness: watch
sha256: b61f9446f6a879bdc69e6e15796b7b88cf5a0f0029361cd01766f4bf9fb1f354
...
# 主问题：如何设计 [[Agent]] 的短期[[Memory|记忆]]、[[Long-term Memory|长期记忆]]和[[Agent State|运行状态]]？
...
追问题目：主问题：如何设计 Agent 的短期记忆、长期记忆和运行状态？

出现位置：记忆系统与状态设计（短期/长期/State）
