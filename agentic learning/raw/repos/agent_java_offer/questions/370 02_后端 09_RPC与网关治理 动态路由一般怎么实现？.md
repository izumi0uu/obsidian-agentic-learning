...
freshness: watch
sha256: 6096f725fe706908334fbdb1b8d298f95b031ee7f7aa4e40e55f1bb2dbf74837
...
答：常见做法是路由配置中心化存储，网关实例通过订阅推送或定时拉取刷新本地路由表，刷新过程走版本号与原子替换，避免半更新状态。路由规则要支持回滚，且变更全链路可[[Audit Log|审计]]。
