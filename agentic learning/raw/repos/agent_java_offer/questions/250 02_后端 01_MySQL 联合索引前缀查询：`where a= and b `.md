...
freshness: watch
sha256: 9103128d6f459821c66477064203115cc2e0988a9e111a760806d580c96d3bc9
...
父级题组：为什么 OLTP（联机事务处理） 常用 B+Tree 而不是 Hash？
...
追问题目：3. 联合索引前缀查询：`where a=? and b>?`

出现位置：为什么 OLTP（联机事务处理） 常用 B+Tree 而不是 Hash？
