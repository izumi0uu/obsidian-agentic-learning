...
freshness: watch
sha256: 6b0169bd96ac5651da361b6f90769b997c8cf55442a3d2f79db6269cc7ab2d2a
...
追问题目：主问题：如何从零搭建一个可用的 RAG 系统？

出现位置：RAG全链路搭建（数据→切块→嵌入→索引→生成）
