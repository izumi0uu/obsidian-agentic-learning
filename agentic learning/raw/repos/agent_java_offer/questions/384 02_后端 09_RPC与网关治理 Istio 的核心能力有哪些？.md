...
freshness: watch
sha256: 4ed6bf79c0a5aca4dc3e7aed60cf9125e1bfb228ce361df14563adcbabd72ae9
...
答：核心是流量治理（路由、灰度、熔断）、安全（mTLS、身份认证、授权）和[[Observability|可观测]]（指标、日志、[[Trace|追踪]]）。控制面下发策略，数据面执行策略。实际落地要严格做版本治理和配置[[Audit Log|审计]]。
