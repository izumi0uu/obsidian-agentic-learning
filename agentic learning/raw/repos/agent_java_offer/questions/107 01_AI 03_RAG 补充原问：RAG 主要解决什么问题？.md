...
freshness: watch
sha256: 7faa12074c377086a58d790c2d6b453f681a8fe1b81a8eb963bfc3c55b54e048
...
**口述答案（约300字）**：
我理解RAG是“检索增强生成”，核心价值是把外部知识在推理时注入模型，解决模型知识时效性差、专业领域覆盖不足和事实[[Hallucination|幻觉]]问题。它主要解决三类问题：第一，知识更新问题，不需要重新训练就能接入新资料；第二，可解释性问题，回答可附引用来源；第三，成本问题，相比全量微调，RAG迭代更快更便宜。它的边界也要讲清：RAG不能替代推理能力，召回不准时输出也会差，所以要重视[[Chunking|分块]]、召回、重排和[[Prompt]]约束。我的实践原则是“先保障召回，再优化生成”，并用线上bad case持续回流，形成检索与提示词的双闭环优化。
**来源**：公开社区资料
