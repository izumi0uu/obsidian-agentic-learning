...
freshness: watch
sha256: 861815edaf47654d5b466ff427dd62f45ba778f2d59f907084d0446fd136979b
...
追问题目：- **知识库的实时更新：** 如何高效地保持向量索引与源数据的同步？当源文档被修改或删除时，需要有可靠的机制来更新或废弃对应的向量，这涉及到复杂的ETL（Extract, Transform, Load）流程。

出现位置：RAG 系统在实际部署中可能面临哪些挑战？
