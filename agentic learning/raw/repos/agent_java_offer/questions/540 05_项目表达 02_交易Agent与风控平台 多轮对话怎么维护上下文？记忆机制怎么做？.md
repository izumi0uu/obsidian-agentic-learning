...
freshness: watch
sha256: 4dfcc406fd6393bef528211eebc8c2816631635e860af1b9c6a646ccc8eaa6ad
...
你要能讲出：短期记忆（会话窗口）、[[Long-term Memory|长期记忆]]（[[Vector Database|向量库]]/用户画像）、事件记忆（重要操作）、摘要压缩、失效策略。
如果你回答成“我把历史消息全塞回去”，会比较弱。[[Agent]] 面试现在已经会追问 [[Memory|memory]] 的实际工程取舍。
