...
freshness: watch
sha256: f511bb3f75b8ffc7ac267be732855f08d866c89b540ecfeeb002655742bf1696
...
# 追问：为什么同一个模型在不同系统[[Prompt|提示词]]下表现差异会很大？
...
追问题目：追问：为什么同一个模型在不同系统提示词下表现差异会很大？

出现位置：了解 LLM 的基本原理与使用方式
