...
freshness: watch
sha256: 3e93ed9e590b129a74a0740b1f8aff885c66954c3a5083da0547d50954d46fc5
...
# 为什么要把[[Memory|记忆]]外部化（文件、数据库、[[Vector Database|向量库]]）？
...
父级题组：Wide Research: Beyond the Context Window
...
追问题目：- 问：为什么要把记忆外部化（文件、数据库、向量库）？

出现位置：Wide Research: Beyond the Context Window
