...
- 本地 PDF：`assets/MAP - A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning.pdf`（本轮未保存 PDF，仅用远程 PDF 生成 extracted 文本）
- extracted：`extracted/MAP - A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning.extracted.md`
...
- 支撑概念：
  ...
  - [[Observation]]
- 证据边界：
  - 支撑 [[Observation]]、[[Agent Loop]]；不能证明所有长程任务都应先全局探索。
...
- 支撑概念：
  ...
  - [[Observation]]
- 证据边界：
  - 支撑 [[Planning]]、[[Agent Workflow]]；需要正文确认每阶段输入输出。
...
- 关键步骤：见 [[MAP - A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning#需要我读的内容]]。
