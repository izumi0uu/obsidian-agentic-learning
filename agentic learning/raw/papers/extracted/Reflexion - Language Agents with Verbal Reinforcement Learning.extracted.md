# Reflexion: Language Agents with Verbal Reinforcement Learning - Extracted Text

- Source note: [[Reflexion - Language Agents with Verbal Reinforcement Learning]]
- Source PDF: `assets/Reflexion - Language Agents with Verbal Reinforcement Learning.pdf`
...
receive an observation from the environmentot. We explore various Actor models, including Chain of
...
(2018). HotpotQA: A dataset for diverse, explainable multi-hop question answering. InConference
