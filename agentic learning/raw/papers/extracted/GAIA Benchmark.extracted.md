# GAIA Benchmark - extracted text

Source PDF: [[GAIA Benchmark.pdf]]
...
Number of questions Number of steps taken
desu
sloot
tnereffid
fo
...
Crafting questions. Our questions are created by humans5 and aim to reflect realistic use cases of AI assistants.
...
ot
emiT
Search engine GPT-4 Turbo GPT-4 Plugins (set by humans)
GPT-4 AutoGPT-4 Human
...
reading N/A
Web
browsing Coding Multi-modality
)%(
erocS
...
haviours such as backtracking or query re- Figure 5 Score of various LLMs at Level 1 per capability. Non
finement when the result is not satisfying, zero scores for non tool models for “Diverse filetype reading” and
and relatively long plan execution. We pro- “Multi-modality” are due to tasks that can be solved differently
vide examples of such behaviours in Ap- from the way the annotators did. Non zero scores for non tool
...
Towards unified evaluation of generative models. Many GAIA tasks might be solved by calling modules that
...
between the LLM and other capabilities as in vision-language models (Alayrac et al., 2022; Laurenc¸on et al.,
...
Brown, Adam Santoro, Aditya Gupta, Adria` Garriga-Alonso, Agnieszka Kluska, Aitor Lewkowycz, Akshat Agarwal,
...
Iyer, Anders Johan Andreassen, Andrea Madotto, Andrea Santilli, Andreas Stuhlmu¨ller, Andrew M. Dai, Andrew
...
Bao Sheng Loe, Barret Zoph, Bart(cid:32)lomiej Bojanowski, Batuhan O¨ zyurt, Behnam Hedayatnia, Behnam Neyshabur,
...
Hagerman, Elizabeth Barnes, Elizabeth Donoway, Ellie Pavlick, Emanuele Rodola`, Emma Lam, Eric Chu, Eric Tang,
...
Luheng He, Luis Oliveros-Colo´n, Luke Metz, Lu¨tfi Kerem Senel, Maarten Bosma, Maarten Sap, Maartje Ter Hoeve,
...
Chang, Peter Eckersley, Phu Mon Htut, Pinyu Hwang, Piotr Mil(cid:32)kowski, Piyush Patil, Pouya Pezeshkpour, Priti Oli,
...
Level 1
Level 3
Figure 8 Unsurprisingly, the number of steps taken to
...
GPT4 (Web browsing):
Browsing Bing:
(cid:252) “Vietnamese specimens described by Kuznetzov Nedoshivina 2010 paper deposition location”
(cid:237) Reading content
Result:
...
GPT4 (Web browsing):
Browsing Bing:
(cid:252) “Goldfinger ending scene object color”
Goldfinger (1964) ending / spoiler
(cid:237) Reading content
(cid:252) “Goldfinger ending scene parachute color”
(cid:237) Reading content
✓
