# Corrective Retrieval Augmented Generation - Extracted Text

- Source note: [[Corrective Retrieval Augmented Generation]]
- Source PDF: `assets/Corrective Retrieval Augmented Generation.pdf`
...
Propriety LLMs such as LLaMA2-chat 13B and
...
can be coupled withCRAG easily, while additional
...
Table 10: The few-shot prompt to GPT-3.5 Turbo as the
evaluator.
Given a question, does the following document have exact
information to answer the question? Answer yes or no
only.
