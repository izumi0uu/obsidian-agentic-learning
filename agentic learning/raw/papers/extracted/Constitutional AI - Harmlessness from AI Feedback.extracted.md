# Constitutional AI: Harmlessness from AI Feedback - Extracted Text

- Source note: [[Constitutional AI - Harmlessness from AI Feedback]]
- Source PDF: `assets/Constitutional AI - Harmlessness from AI Feedback.pdf`
...
PM + SL-CAI 
Models
Constitutional AI F eedback
for Self-Impr o v ement
Helpful RLHF 
Model
Gener ate Responses
t o “Red T eaming”
...
assistant by eliminating evasive responses, reducing tension 1 [Bai et al., 2022, Glaese et al., 2022] between
...
Base
Constitutional RL
(Par et o Impr o v ement)Wit h Chain
of Thought
Standar d
RLHFConstitutional SL
Helpful-Only
Helpful
+ Harmless
Figure 2 We show harmlessness versus helpfulness Elo scores (higher is better, only differences are mean-
...
ﬁnetune AI models to be harmless using only of order ten 2 simple principles, stated in natural language.
...
tations of a set of principles back into a hybrid 5 human/AI PM (as we use human labels for helpfulness, but
...
1.3 Contributions
We demonstrate constitutional methods to utilize a helpful RLHF model to train helpfuland harmlessmodels
...
As our goal is to train helpful and harmless assistants from purely helpfulassistants, we use RLHF to train
...
We now discuss a few strategies thatqualitatively seemed to lead to more diverse and higher quality responses.
...
9The evasiveness may have also been caused by asking workers to choose the moreharmful rather than more harmless
...
In contrast to our experiments where we collectrelative harmfulness labels between pairs of model responses,
in [Ganguli et al., 2022] we have also conducted red teaming experiments collectingabsolute harmfulness la-
